...
@property (readonly) IDButton * entryButtonIDRhmiFeatureListOnlineServices;              //@synthesize entryButtonIDRhmiFeatureListOnlineServices=_entryButtonIDRhmiFeatureListOnlineServices - In the implementation block
...
-(IDButton *)entryButtonIDRhmiFeatureListOnlineServices;
-(id)init;
-(id)allViews;
@end
