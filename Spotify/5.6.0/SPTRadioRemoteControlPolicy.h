...
@property (nonatomic,retain) SPTRadioManager * radioManager;                             //@synthesize radioManager=_radioManager - In the implementation block
...
@property (assign,getter=isEnabled,nonatomic) char useThumbUpDownUI;                     //@synthesize useThumbUpDownUI=_useThumbUpDownUI - In the implementation block
...
-(SPTRadioManager *)radioManager;
-(void)setRadioManager:(SPTRadioManager *)arg1 ;
...
-(void)setUseThumbUpDownUI:(char)arg1 ;
