...
@interface SPTSmartDeviceLinkBrowseCommand : SPTSmartDeviceLinkExternalContentPresentation <SPTSmartDeviceLinkCommand> {
...
@property (nonatomic,retain) id<SPTExternalContentItem> browseItem;                              //@synthesize browseItem=_browseItem - In the implementation block
...
-(id<SPTExternalContentItem>)browseItem;
-(id)initWithBrowseItem:(id)arg1 ;
-(void)setBrowseItem:(id<SPTExternalContentItem>)arg1 ;
