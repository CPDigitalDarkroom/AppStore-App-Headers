...
@class UIBezierPath, SPTTheme, NSString;
...
@property (nonatomic,retain) UIBezierPath * interactableAreaMask;                                  //@synthesize interactableAreaMask=_interactableAreaMask - In the implementation block
...
-(UIBezierPath *)interactableAreaMask;
-(void)setInteractableAreaMask:(UIBezierPath *)arg1 ;
