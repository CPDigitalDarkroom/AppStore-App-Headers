...
@interface SPTSmartDeviceLinkChooseArtistCommand : SPTSmartDeviceLinkExternalContentPresentation <SPTSmartDeviceLinkCommand> {
...
@property (nonatomic,retain) id<SPTExternalContentItem> artistsAlbum;                            //@synthesize artistsAlbum=_artistsAlbum - In the implementation block
...
-(id<SPTExternalContentItem>)artistsAlbum;
-(void)setArtistsAlbum:(id<SPTExternalContentItem>)arg1 ;
