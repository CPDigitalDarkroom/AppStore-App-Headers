...
#import <Spotify/SPTInstrumentationService.h>

@protocol SPTClientSessionService;
@class NSString, SPTAllocationContext;

@interface SPTInstrumentationServiceImplementation : NSObject <SPTInstrumentationService> {
...
-(id)provideInstrumentationFactory;
@end
