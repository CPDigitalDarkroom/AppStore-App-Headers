...
@property (readonly) IDButton * entryButtonIDRhmiFeatureListSettings;              //@synthesize entryButtonIDRhmiFeatureListSettings=_entryButtonIDRhmiFeatureListSettings - In the implementation block
...
-(IDButton *)entryButtonIDRhmiFeatureListSettings;
-(id)init;
-(id)allViews;
@end
