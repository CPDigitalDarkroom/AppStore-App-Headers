...
#import <Spotify/HUBComponentContentOffsetObserver.h>

@class UIView, NSString, NSSet;

@interface SPTHubHeaderViewComponent : NSObject <HUBComponentWithImageHandling, HUBComponentContentOffsetObserver> {
...
-(NSSet *)layoutTraits;
-(unsigned)headerViewStyleFromComponentModel:(id)arg1 ;
-(void)updateViewForChangedContentOffset:(CGPoint)arg1 ;
-(UIView *)view;
