...
@class NSMutableArray, NSMutableDictionary, GCKMediaInformation, NSArray;
...
@interface GCKMediaStatus : NSObject <NSCopying> {
	...
	float _volume;
	int _queueRepeatMode;
	unsigned _currentItemID;
	unsigned _preloadedItemID;
	unsigned _loadingItemID;
...
@property (assign,nonatomic) int queueRepeatMode;                                 //@synthesize queueRepeatMode=_queueRepeatMode - In the implementation block
@property (assign,nonatomic) unsigned currentItemID;                              //@synthesize currentItemID=_currentItemID - In the implementation block
@property (assign,nonatomic) unsigned preloadedItemID;                            //@synthesize preloadedItemID=_preloadedItemID - In the implementation block
@property (assign,nonatomic) unsigned loadingItemID;                              //@synthesize loadingItemID=_loadingItemID - In the implementation block
...
-(unsigned)currentItemID;
-(void)setCurrentItemID:(unsigned)arg1 ;
-(unsigned)preloadedItemID;
-(void)setPreloadedItemID:(unsigned)arg1 ;
-(unsigned)loadingItemID;
-(void)setLoadingItemID:(unsigned)arg1 ;
-(char)updateQueueFromJSONObject:(id)arg1 ;
-(int)queueRepeatMode;
-(void)setQueueRepeatMode:(int)arg1 ;
-(id)queueItemWithItemID:(unsigned)arg1 ;
-(int)queueIndexForItemID:(unsigned)arg1 ;
-(unsigned)queueItemCount;
-(id)queueItemAtIndex:(unsigned)arg1 ;
-(int)idleReason;
-(id)initWithSessionID:(int)arg1 mediaInformation:(id)arg2 queueItems:(id)arg3 currentItemID:(unsigned)arg4 ;
