...
@interface SPTSmartDeviceLinkChooseRadioCommand : SPTSmartDeviceLinkExternalContentPresentation <SPTSmartDeviceLinkCommand> {
...
@property (nonatomic,retain) id<SPTExternalContentItem> radioItem;                               //@synthesize radioItem=_radioItem - In the implementation block
...
-(id<SPTExternalContentItem>)radioItem;
-(void)setRadioItem:(id<SPTExternalContentItem>)arg1 ;
