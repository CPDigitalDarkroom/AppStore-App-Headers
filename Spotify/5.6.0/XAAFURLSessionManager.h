...
@class NSURLSession, NSOperationQueue, XAAFSecurityPolicy, XAAFNetworkReachabilityManager, NSObject, NSURLSessionConfiguration, NSMutableDictionary, NSLock, NSArray, NSString;
...
@property (assign,nonatomic) char attemptsToRecreateUploadTasksForBackgroundSessions;                      //@synthesize attemptsToRecreateUploadTasksForBackgroundSessions=_attemptsToRecreateUploadTasksForBackgroundSessions - In the implementation block
...
-(char)attemptsToRecreateUploadTasksForBackgroundSessions;
...
-(void)setAttemptsToRecreateUploadTasksForBackgroundSessions:(char)arg1 ;
