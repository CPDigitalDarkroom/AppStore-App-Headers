...
@class SPTTableView, UIView, SPTGaiaDevicePickerMaskView, NSString;
...
-(void)setAccessoryView:(id)arg1 animated:(char)arg2 ;
...
-(void)setMaskView:(SPTGaiaDevicePickerMaskView *)arg1 ;
-(SPTGaiaDevicePickerMaskView *)maskView;
