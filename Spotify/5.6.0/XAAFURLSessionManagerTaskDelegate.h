...
@class XAAFURLSessionManager, NSMutableData, NSProgress, NSURL, NSString;
...
@property (assign,nonatomic,__weak) XAAFURLSessionManager * manager;              //@synthesize manager=_manager - In the implementation block
...
-(void)setManager:(XAAFURLSessionManager *)arg1 ;
-(XAAFURLSessionManager *)manager;
