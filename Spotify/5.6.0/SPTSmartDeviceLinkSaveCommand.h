...
@interface SPTSmartDeviceLinkSaveCommand : NSObject <SPTSmartDeviceLinkCommand> {

	char _saveStateAtLastAdded;
...
@property (assign,nonatomic) char saveStateAtLastAdded;                                          //@synthesize saveStateAtLastAdded=_saveStateAtLastAdded - In the implementation block
...
-(void)setSaveStateAtLastAdded:(char)arg1 ;
-(char)saveStateAtLastAdded;
