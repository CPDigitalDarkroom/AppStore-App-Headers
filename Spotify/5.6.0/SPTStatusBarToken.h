...
@property (assign,nonatomic,__weak) SPTStatusBarManager * manager;              //@synthesize manager=_manager - In the implementation block
-(id)initWithStatusBarManager:(id)arg1 ;
-(void)setManager:(SPTStatusBarManager *)arg1 ;
-(SPTStatusBarManager *)manager;
-(void)dealloc;
-(void)invalidate;
@end
