...
@property (assign,nonatomic,__weak) id<SPTCollectionSongItemPlaying> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(id)initWithEntityURL:(id)arg1 track:(id)arg2 subtitleType:(unsigned)arg3 ;
...
-(void)setDelegate:(id<SPTCollectionSongItemPlaying>)arg1 ;
-(void)setTitle:(NSString *)arg1 ;
-(id<SPTCollectionSongItemPlaying>)delegate;
-(void)action;
-(NSString *)title;
-(char)isEnabled;
