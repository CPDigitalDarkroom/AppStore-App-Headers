...
@property (readonly) IDButton * entryButtonIDRhmiFeatureListMediaRadio;              //@synthesize entryButtonIDRhmiFeatureListMediaRadio=_entryButtonIDRhmiFeatureListMediaRadio - In the implementation block
...
-(IDButton *)entryButtonIDRhmiFeatureListMediaRadio;
