...
@property (assign,nonatomic,__weak) id<GCKProximityInfoChannelDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
-(void)didDisconnect;
...
-(void)setDelegate:(id<GCKProximityInfoChannelDelegate>)arg1 ;
-(id<GCKProximityInfoChannelDelegate>)delegate;
@end
