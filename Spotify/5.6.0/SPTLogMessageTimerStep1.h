...
@property (nonatomic,retain) NSString * timerNameValue;                  //@synthesize timerNameValue=_timerNameValue - In the implementation block
...
+(id)messageWithTimerName:(id)arg1 subdivision:(id)arg2 isFirst:(char)arg3 isLast:(char)arg4 timerStepName:(id)arg5 msSinceEpoch:(long long)arg6 sequenceId:(id)arg7 ;
