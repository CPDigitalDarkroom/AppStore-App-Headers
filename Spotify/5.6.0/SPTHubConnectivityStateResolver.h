...
#import <Spotify/HUBConnectivityStateResolver.h>

@class SPTNetworkConnectivityController, NSString;

@interface SPTHubConnectivityStateResolver : NSObject <HUBConnectivityStateResolver> {
...
-(unsigned)resolveConnectivityState;
