...
@property (nonatomic,retain) NSMutableArray * requirements;              //@synthesize requirements=_requirements - In the implementation block
+(id)requirementSet;
-(NSMutableArray *)requirements;
-(void)addRequirement:(/*^block*/id)arg1 ;
