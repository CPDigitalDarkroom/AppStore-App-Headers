...
@class SPTSmartDeviceLinkSession, NSString;

@interface SPTSmartDeviceLinkNowPlayingCommand : NSObject <SPTSmartDeviceLinkCommand> {

	id<SPTSmartDeviceLinkCommandDelegate> delegate;
	SPTSmartDeviceLinkSession* _session;

}

@property (assign,nonatomic,__weak) SPTSmartDeviceLinkSession * session;                         //@synthesize session=_session - In the implementation block
...
-(SPTSmartDeviceLinkSession *)session;
-(void)setDelegate:(id<SPTSmartDeviceLinkCommandDelegate>)arg1 ;
-(id<SPTSmartDeviceLinkCommandDelegate>)delegate;
-(void)setSession:(SPTSmartDeviceLinkSession *)arg1 ;
-(unsigned)commandID;
@end
