...
@property (readonly) IDButton * entryButtonIDRhmiFeatureListRadio;              //@synthesize entryButtonIDRhmiFeatureListRadio=_entryButtonIDRhmiFeatureListRadio - In the implementation block
...
-(IDButton *)entryButtonIDRhmiFeatureListRadio;
-(id)init;
-(id)allViews;
@end
