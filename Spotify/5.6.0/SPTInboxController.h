...
@class SPPlaylistContext, SPSession, SPPlaylist, NSString;

@interface SPTInboxController : NSObject <SPSessionObserver> {
...
@property (nonatomic,readonly) SPPlaylist * playlist; 
