...
@property (nonatomic,readonly) NSArray * videoAdsArray;                 //@synthesize videoAdsArray=_videoAdsArray - In the implementation block
@property (nonatomic,readonly) NSArray * passthroughArray;              //@synthesize passthroughArray=_passthroughArray - In the implementation block
...
-(NSArray *)videoAdsArray;
-(NSArray *)passthroughArray;
@end
