...
+(id)endpointPath;
+(id)HTTPMethod;
-(id)initWithStatus:(id)arg1 media:(id)arg2 inReplyToStatusID:(id)arg3 latitude:(id)arg4 longitude:(id)arg5 impressionID:(id)arg6 earned:(char)arg7 polling:(char)arg8 configuration:(id)arg9 responseModelBuilder:(id)arg10 ;
