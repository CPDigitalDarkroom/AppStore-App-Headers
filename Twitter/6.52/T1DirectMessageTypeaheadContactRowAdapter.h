...
@protocol T1DirectMessageTypeaheadContactRowAdapterDelegate;
@class TFNTwitterAccount, TFNTwitterScribeContext, NSString;

@interface T1DirectMessageTypeaheadContactRowAdapter : TFNItemsTableRowAdapter <TFNTwitterAuthenticated> {

	TFNTwitterAccount* _account;
	TFNTwitterScribeContext* _scribeContext;
	id<T1DirectMessageTypeaheadContactRowAdapterDelegate> _delegate;
...
@property (assign,nonatomic,__weak) id<T1DirectMessageTypeaheadContactRowAdapterDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)setDelegate:(id<T1DirectMessageTypeaheadContactRowAdapterDelegate>)arg1 ;
-(id<T1DirectMessageTypeaheadContactRowAdapterDelegate>)delegate;
