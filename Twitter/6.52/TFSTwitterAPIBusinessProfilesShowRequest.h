...
@interface TFSTwitterAPIBusinessProfilesShowRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
...
-(id)initWithUserID:(id)arg1 countryCode:(id)arg2 polling:(char)arg3 configuration:(id)arg4 responseModelBuilder:(id)arg5 ;
@end
