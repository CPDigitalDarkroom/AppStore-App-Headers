...
@property (nonatomic,retain) NSNumber * tweetID;                 //@synthesize tweetID=_tweetID - In the implementation block
-(NSString *)timelineID;
...
-(NSNumber *)tweetID;
-(id)initWithService:(id)arg1 accountID:(id)arg2 timelineID:(id)arg3 tweetID:(id)arg4 source:(unsigned)arg5 completionBlock:(/*^block*/id)arg6 ;
-(void)setTweetID:(NSNumber *)arg1 ;
@end
