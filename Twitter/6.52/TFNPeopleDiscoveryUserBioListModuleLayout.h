...
@protocol TFNPeopleDiscoveryUserBioListModuleLayout <TFNPeopleDiscoveryModuleLayout>
...
@interface TFNPeopleDiscoveryUserBioListModuleLayout : TFNPeopleDiscoveryModuleLayout <TFNPeopleDiscoveryUserBioListModuleLayout> {
...
-(id)initWithModuleLayoutHeader:(id)arg1 userRecommendations:(id)arg2 ;
-(id)init;
@end
