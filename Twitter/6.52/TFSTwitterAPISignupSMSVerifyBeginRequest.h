...
@interface TFSTwitterAPISignupSMSVerifyBeginRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
+(unsigned)responseHydrationFlags;
+(unsigned)supportedAuthenticationTypes;
+(id)HTTPMethod;
-(id)initWithRawPhoneNumber:(id)arg1 countryCode:(id)arg2 notificationsDisabled:(char)arg3 polling:(char)arg4 configuration:(id)arg5 responseModelBuilder:(id)arg6 ;
