...
-(id)initWithService:(id)arg1 accountID:(id)arg2 accountModel:(id)arg3 userID:(id)arg4 impressionID:(id)arg5 isEarned:(char)arg6 completionBlock:(/*^block*/id)arg7 ;
-(id)initWithService:(id)arg1 accountID:(id)arg2 accountModel:(id)arg3 screenName:(id)arg4 impressionID:(id)arg5 isEarned:(char)arg6 completionBlock:(/*^block*/id)arg7 ;
-(NSNumber *)userID;
-(NSString *)screenName;
@end
