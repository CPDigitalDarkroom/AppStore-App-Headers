...
+(id)HTTPMethod;
-(id)initWithUserID:(id)arg1 screenName:(id)arg2 lifeline:(char)arg3 handlesChallenges:(char)arg4 challengesPassed:(char)arg5 impressionID:(id)arg6 earned:(char)arg7 polling:(char)arg8 configuration:(id)arg9 responseModelBuilder:(id)arg10 ;
