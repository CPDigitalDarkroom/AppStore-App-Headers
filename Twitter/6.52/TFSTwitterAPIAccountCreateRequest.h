...
+(id)HTTPMethod;
-(id)initWithScreenName:(id)arg1 password:(id)arg2 name:(id)arg3 email:(id)arg4 phoneNumber:(id)arg5 lang:(id)arg6 uiMetricResult:(id)arg7 discoverableByEmail:(char)arg8 discoverableByMobilePhone:(char)arg9 notificationsDisabled:(char)arg10 polling:(char)arg11 configuration:(id)arg12 responseModelBuilder:(id)arg13 ;
