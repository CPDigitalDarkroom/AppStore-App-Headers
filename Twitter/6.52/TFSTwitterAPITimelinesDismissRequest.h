...
+(id)HTTPMethod;
-(id)initWithTweetIDs:(id)arg1 userIDs:(id)arg2 controllerData:(id)arg3 sourceData:(id)arg4 suggestionType:(id)arg5 feedbackType:(id)arg6 undo:(char)arg7 polling:(char)arg8 configuration:(id)arg9 responseModelBuilder:(id)arg10 ;
