...
+(id)endpointPath;
-(id)initWithSinceID:(id)arg1 maxID:(id)arg2 count:(id)arg3 modelVersion:(id)arg4 filters:(unsigned)arg5 forceBuckets:(unsigned)arg6 polling:(char)arg7 configuration:(id)arg8 responseModelBuilder:(id)arg9 ;
