...
@interface TFSTwitterAPIStickerProviderCategoriesRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
+(unsigned)responseHydrationFlags;
-(id)initWithPolling:(char)arg1 configuration:(id)arg2 responseModelBuilder:(id)arg3 ;
