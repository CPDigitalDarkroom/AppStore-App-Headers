...
@class T1NativeMediaAppCardViewModel, T1NativeMediaAppCardViewEventRegistry, T1NativePlayerCardPlayerContainerView, TFNTappableHighlightView, T1NativeAppCardDetailsView, UIView, UIImage, NSString;
...
-(void)_updatePlayerContainerWithPreviewImage:(id)arg1 state:(unsigned)arg2 ;
