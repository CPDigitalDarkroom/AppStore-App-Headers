...
+(id)HTTPMethod;
-(id)initWithMonitize:(char)arg1 videoCategories:(id)arg2 advertiserBlacklist:(id)arg3 categoryBlacklist:(id)arg4 polling:(char)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
