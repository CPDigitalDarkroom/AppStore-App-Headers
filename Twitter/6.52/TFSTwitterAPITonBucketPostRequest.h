...
+(id)HTTPMethod;
-(id)initWithBucket:(id)arg1 contentType:(id)arg2 path:(id)arg3 expiresDateString:(id)arg4 polling:(char)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
