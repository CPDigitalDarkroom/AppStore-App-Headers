...
+(id)_actionStringForAction:(unsigned)arg1 ;
+(id)endpointPath;
+(unsigned)responseHydrationFlags;
+(id)HTTPMethod;
-(id)initWithUserID:(id)arg1 promptID:(id)arg2 action:(unsigned)arg3 polling:(char)arg4 configuration:(id)arg5 responseModelBuilder:(id)arg6 ;
