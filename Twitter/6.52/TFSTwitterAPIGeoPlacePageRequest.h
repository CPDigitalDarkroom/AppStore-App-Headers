...
@interface TFSTwitterAPIGeoPlacePageRequest : TFSTwitterAPIEndpointRequest
+(id)_requestTypeStringForType:(unsigned)arg1 ;
+(id)_cursorTypeStringForType:(unsigned)arg1 ;
+(id)endpointPath;
+(unsigned)responseHydrationFlags;
-(id)initWithPlaceID:(id)arg1 requestType:(unsigned)arg2 includeHeader:(char)arg3 cursor:(id)arg4 cursorType:(unsigned)arg5 polling:(char)arg6 configuration:(id)arg7 responseModelBuilder:(id)arg8 ;
