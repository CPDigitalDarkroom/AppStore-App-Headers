...
@property (assign,nonatomic) char skipStatus;                                    //@synthesize skipStatus=_skipStatus - In the implementation block
...
-(id)initWithService:(id)arg1 accountID:(id)arg2 accountModel:(id)arg3 userID:(id)arg4 cursor:(id)arg5 skipStatus:(char)arg6 source:(unsigned)arg7 completionBlock:(/*^block*/id)arg8 ;
-(id)initWithService:(id)arg1 accountID:(id)arg2 accountModel:(id)arg3 screenName:(id)arg4 cursor:(id)arg5 skipStatus:(char)arg6 source:(unsigned)arg7 completionBlock:(/*^block*/id)arg8 ;
-(char)skipStatus;
-(unsigned)friendsRequestType;
-(void)setSkipStatus:(char)arg1 ;
-(NSString *)cursor;
