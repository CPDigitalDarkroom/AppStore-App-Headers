...
@interface TFSTwitterAPIScheduledStatusCreateRequest : TFSTwitterAPIEndpointRequest
+(unsigned)responseHydrationFlags;
+(id)HTTPMethod;
-(id)initWithStatusText:(id)arg1 scheduleDate:(id)arg2 mediaIDs:(id)arg3 inReplyToStatusID:(id)arg4 latitude:(id)arg5 longitude:(id)arg6 geoPlaceID:(id)arg7 polling:(char)arg8 configuration:(id)arg9 responseModelBuilder:(id)arg10 ;
