...
-(id)initWithCountryCode:(id)arg1 language:(id)arg2 maxResults:(id)arg3 topicID:(id)arg4 polling:(char)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
@end
