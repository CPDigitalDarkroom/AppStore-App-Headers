...
+(id)HTTPMethod;
-(id)initWithTweetIDs:(id)arg1 userIDs:(id)arg2 momentIDs:(id)arg3 controllerData:(id)arg4 sourceData:(id)arg5 suggestionType:(id)arg6 feedbackType:(id)arg7 undo:(char)arg8 polling:(char)arg9 configuration:(id)arg10 responseModelBuilder:(id)arg11 ;
