...
-(char)_performAPIRequestAdditionalParameters:(id)arg1 viewEvent:(id)arg2 context:(id)arg3 ;
-(char)_isWhitelistedAPICallURL:(id)arg1 account:(id)arg2 ;
-(id)_httpParametersForContext:(id)arg1 additionalParameters:(id)arg2 ;
