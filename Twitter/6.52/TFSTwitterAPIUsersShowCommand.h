...
-(id)initWithService:(id)arg1 accountID:(id)arg2 screenName:(id)arg3 accountModel:(id)arg4 source:(unsigned)arg5 completionBlock:(/*^block*/id)arg6 ;
-(id)initWithService:(id)arg1 accountID:(id)arg2 userID:(id)arg3 accountModel:(id)arg4 source:(unsigned)arg5 completionBlock:(/*^block*/id)arg6 ;
