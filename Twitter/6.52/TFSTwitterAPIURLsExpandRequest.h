...
@interface TFSTwitterAPIURLsExpandRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
+(unsigned)responseHydrationFlags;
-(id)initWithTcoIDs:(id)arg1 polling:(char)arg2 configuration:(id)arg3 responseModelBuilder:(id)arg4 ;
