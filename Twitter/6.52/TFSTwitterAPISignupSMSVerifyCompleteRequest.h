...
@interface TFSTwitterAPISignupSMSVerifyCompleteRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
+(unsigned)responseHydrationFlags;
+(unsigned)supportedAuthenticationTypes;
+(id)HTTPMethod;
-(id)initWithPhoneNumber:(id)arg1 pin:(id)arg2 polling:(char)arg3 configuration:(id)arg4 responseModelBuilder:(id)arg5 ;
