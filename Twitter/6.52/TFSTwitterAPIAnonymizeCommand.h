...
@property (nonatomic,retain) NSDictionary * appTrackingParameters;              //@synthesize appTrackingParameters=_appTrackingParameters - In the implementation block
+(id)appTrackingDictionary:(id)arg1 userAgent:(id)arg2 ;
-(id)initWithService:(id)arg1 accountID:(id)arg2 appTrackingParameters:(id)arg3 source:(unsigned)arg4 completionBlock:(/*^block*/id)arg5 ;
...
-(NSDictionary *)appTrackingParameters;
-(void)setAppTrackingParameters:(NSDictionary *)arg1 ;
@end
