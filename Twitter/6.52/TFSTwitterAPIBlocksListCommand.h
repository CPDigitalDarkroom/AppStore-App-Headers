...
@property (assign,nonatomic) unsigned blockType;                                 //@synthesize blockType=_blockType - In the implementation block
...
-(id)initWithService:(id)arg1 accountID:(id)arg2 accountModel:(id)arg3 cursor:(id)arg4 imported:(char)arg5 source:(unsigned)arg6 completionBlock:(/*^block*/id)arg7 ;
-(void)setBlockType:(unsigned)arg1 ;
-(NSString *)cursor;
