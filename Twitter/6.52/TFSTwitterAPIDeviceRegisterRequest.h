...
+(id)HTTPMethod;
-(id)initWithRawPhoneNumber:(id)arg1 textMessage:(id)arg2 concatURL:(char)arg3 sendNumericPIN:(char)arg4 notificationsDisabled:(char)arg5 updatePhone:(char)arg6 polling:(char)arg7 configuration:(id)arg8 responseModelBuilder:(id)arg9 ;
