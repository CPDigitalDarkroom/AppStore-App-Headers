...
+(id)HTTPMethod;
-(id)initWithLog:(id)arg1 language:(id)arg2 eventParameters:(id)arg3 isCompressed:(char)arg4 isDebug:(char)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
