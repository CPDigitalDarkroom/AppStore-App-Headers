...
+(id)HTTPMethod;
-(id)initWithBannerData:(id)arg1 bannerFileName:(id)arg2 size:(CGSize)arg3 leftOffset:(float)arg4 topOffset:(float)arg5 polling:(char)arg6 configuration:(id)arg7 responseModelBuilder:(id)arg8 ;
