...
@interface TFSTwitterAPIStickerProviderStickerByIDRequest : TFSTwitterAPIEndpointRequest
+(unsigned)responseHydrationFlags;
-(id)initWithPolling:(char)arg1 configuration:(id)arg2 responseModelBuilder:(id)arg3 stickerID:(id)arg4 ;
