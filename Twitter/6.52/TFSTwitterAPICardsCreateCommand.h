...
@property (nonatomic,copy) NSDictionary * cardData;              //@synthesize cardData=_cardData - In the implementation block
-(NSDictionary *)cardData;
-(void)setCardData:(NSDictionary *)arg1 ;
...
-(id)initWithService:(id)arg1 accountID:(id)arg2 cardData:(id)arg3 scribeNetworkOperation:(id)arg4 source:(unsigned)arg5 completionBlock:(/*^block*/id)arg6 ;
