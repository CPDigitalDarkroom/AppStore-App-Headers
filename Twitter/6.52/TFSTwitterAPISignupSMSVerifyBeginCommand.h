...
@interface TFSTwitterAPISignupSMSVerifyBeginCommand : TFSTwitterAPICommand {
...
-(id)initWithService:(id)arg1 phoneNumber:(id)arg2 countryCode:(id)arg3 notificationsDisabled:(char)arg4 source:(unsigned)arg5 completionBlock:(/*^block*/id)arg6 ;
