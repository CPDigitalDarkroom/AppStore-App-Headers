...
@interface TFSTwitterAPIVideosSuggestionsRequest : TFSTwitterAPIEndpointRequest
+(id)stringForBool:(char)arg1 ;
+(id)endpointPath;
+(unsigned)responseHydrationFlags;
-(id)initWithSeedStatusIDs:(id)arg1 excludedStatusIDs:(id)arg2 supportsPromotedContent:(char)arg3 allowNSFW:(char)arg4 includedMediaTypes:(unsigned)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
