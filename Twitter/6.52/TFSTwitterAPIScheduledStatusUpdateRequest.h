...
@interface TFSTwitterAPIScheduledStatusUpdateRequest : TFSTwitterAPIEndpointRequest
+(unsigned)responseHydrationFlags;
+(id)HTTPMethod;
-(id)initWithScheduledStatusID:(long long)arg1 statusText:(id)arg2 scheduleDate:(id)arg3 mediaIDs:(id)arg4 inReplyToStatusID:(id)arg5 latitude:(id)arg6 longitude:(id)arg7 geoPlaceID:(id)arg8 polling:(char)arg9 configuration:(id)arg10 responseModelBuilder:(id)arg11 ;
