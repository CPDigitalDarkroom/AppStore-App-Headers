...
@property (nonatomic,retain) NSArray * screenNames;              //@synthesize screenNames=_screenNames - In the implementation block
-(NSArray *)userIDs;
...
-(NSArray *)screenNames;
-(id)initWithService:(id)arg1 accountID:(id)arg2 userIDs:(id)arg3 screenNames:(id)arg4 source:(unsigned)arg5 completionBlock:(/*^block*/id)arg6 ;
-(void)setScreenNames:(NSArray *)arg1 ;
@end
