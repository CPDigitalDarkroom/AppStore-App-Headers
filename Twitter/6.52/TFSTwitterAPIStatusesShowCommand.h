...
@class TFNTwitterAccountModel, NSNumber, NSDictionary;
...
@property (nonatomic,retain) NSDictionary * extendedStatusParametersDictionary;              //@synthesize extendedStatusParametersDictionary=_extendedStatusParametersDictionary - In the implementation block
-(NSNumber *)statusID;
...
-(id)initWithService:(id)arg1 accountID:(id)arg2 accountUserID:(long long)arg3 accountModel:(id)arg4 statusID:(id)arg5 extendedStatusParametersDictionary:(id)arg6 source:(unsigned)arg7 completionBlock:(/*^block*/id)arg8 ;
-(NSDictionary *)extendedStatusParametersDictionary;
-(void)setExtendedStatusParametersDictionary:(NSDictionary *)arg1 ;
@end
