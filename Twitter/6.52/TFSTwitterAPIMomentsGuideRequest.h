...
-(id)initWithCategoryID:(id)arg1 hydrationCount:(unsigned)arg2 UTCOffset:(id)arg3 includeBlocking:(char)arg4 loadCapsuleContents:(char)arg5 polling:(char)arg6 configuration:(id)arg7 responseModelBuilder:(id)arg8 ;
