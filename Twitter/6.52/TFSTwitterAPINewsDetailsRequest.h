...
+(id)endpointPath;
-(id)initWithClusterID:(id)arg1 countryCode:(id)arg2 language:(id)arg3 maxTweets:(id)arg4 polling:(char)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
