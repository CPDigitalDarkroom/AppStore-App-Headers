...
-(void)scopedContainerViewController:(id)arg1 willSelectViewControllerAtIndex:(int)arg2;
-(void)scopedContainerViewController:(id)arg1 didSelectViewControllerAtIndex:(int)arg2;
