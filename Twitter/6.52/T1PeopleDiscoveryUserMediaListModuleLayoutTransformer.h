...
@class TFNTwitterAccount, NSString, NSPredicate;

@interface T1PeopleDiscoveryUserMediaListModuleLayoutTransformer : NSObject <T1PeopleDiscoveryModuleLayoutTransformer> {
