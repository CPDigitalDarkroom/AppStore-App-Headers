...
@interface TFSTwitterAPIScheduledStatusListRequest : TFSTwitterAPIEndpointRequest
+(unsigned)responseHydrationFlags;
-(id)initWithEarliestExecutionDate:(id)arg1 state:(id)arg2 order:(int)arg3 polling:(char)arg4 configuration:(id)arg5 responseModelBuilder:(id)arg6 ;
