...
+(id)HTTPMethod;
-(id)initWithMediaID:(id)arg1 monetize:(char)arg2 videoCategories:(id)arg3 advertiserBlacklist:(id)arg4 categoryBlacklist:(id)arg5 polling:(char)arg6 configuration:(id)arg7 responseModelBuilder:(id)arg8 ;
