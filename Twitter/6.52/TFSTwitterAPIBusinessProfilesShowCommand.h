...
@interface TFSTwitterAPIBusinessProfilesShowCommand : TFSTwitterAPICommand {
...
-(id)initWithService:(id)arg1 accountID:(id)arg2 userID:(id)arg3 countryCode:(id)arg4 source:(unsigned)arg5 completionBlock:(/*^block*/id)arg6 ;
