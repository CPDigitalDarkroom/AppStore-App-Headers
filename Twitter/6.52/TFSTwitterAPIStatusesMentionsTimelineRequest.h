...
+(id)endpointPath;
-(id)initWithCount:(id)arg1 sinceID:(id)arg2 maxID:(id)arg3 filters:(unsigned)arg4 forceBuckets:(unsigned)arg5 polling:(char)arg6 configuration:(id)arg7 responseModelBuilder:(id)arg8 ;
