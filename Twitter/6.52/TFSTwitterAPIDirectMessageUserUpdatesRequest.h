...
-(id)initWithCursor:(id)arg1 includeGroups:(char)arg2 dmUsers:(char)arg3 activeConversationID:(id)arg4 polling:(char)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
