...
-(id)initWithQueryType:(id)arg1 searchTerm:(id)arg2 lat:(id)arg3 lng:(id)arg4 hacc:(id)arg5 wifiOn:(char)arg6 os:(id)arg7 deviceType:(id)arg8 polling:(char)arg9 configuration:(id)arg10 responseModelBuilder:(id)arg11 ;
