...
+(id)endpointPath;
-(id)initWithTimelineID:(id)arg1 minPosition:(id)arg2 maxPosition:(id)arg3 count:(id)arg4 includeRetweets:(char)arg5 earned:(char)arg6 polling:(char)arg7 configuration:(id)arg8 responseModelBuilder:(id)arg9 ;
