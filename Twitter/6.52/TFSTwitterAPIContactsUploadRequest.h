...
+(id)HTTPMethod;
-(id)initWithVcardsJSONData:(id)arg1 optInToLiveSync:(char)arg2 isLiveSyncRequest:(char)arg3 polling:(char)arg4 configuration:(id)arg5 responseModelBuilder:(id)arg6 ;
