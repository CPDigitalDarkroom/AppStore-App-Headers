...
+(id)endpointPath;
+(id)HTTPMethod;
-(id)initWithStatusID:(id)arg1 authorID:(id)arg2 impressionID:(id)arg3 lastTweets:(id)arg4 allowPromotedContent:(char)arg5 polling:(char)arg6 configuration:(id)arg7 responseModelBuilder:(id)arg8 ;
