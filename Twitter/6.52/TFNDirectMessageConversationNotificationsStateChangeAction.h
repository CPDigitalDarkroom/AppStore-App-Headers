...
@interface TFNDirectMessageConversationNotificationsStateChangeAction : NSOperation {

	char _notificationsState;
...
-(id)initWithConversation:(id)arg1 notificationsState:(char)arg2 ;
