...
@interface TFSTwitterAPIAlertsLandingPageRequest : TFSTwitterAPIEndpointRequest
-(id)initWithAlertID:(long long)arg1 maxResultCount:(id)arg2 upCursor:(id)arg3 downCursor:(id)arg4 polling:(char)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
