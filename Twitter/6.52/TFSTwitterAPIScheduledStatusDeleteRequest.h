...
@interface TFSTwitterAPIScheduledStatusDeleteRequest : TFSTwitterAPIEndpointRequest
+(unsigned)responseHydrationFlags;
+(id)HTTPMethod;
-(id)initWithScheduledStatusID:(long long)arg1 polling:(char)arg2 configuration:(id)arg3 responseModelBuilder:(id)arg4 ;
