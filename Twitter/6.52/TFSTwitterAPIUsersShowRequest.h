...
-(id)initWithUserID:(id)arg1 screenName:(id)arg2 polling:(char)arg3 configuration:(id)arg4 responseModelBuilder:(id)arg5 ;
-(id)initWithUserID:(id)arg1 polling:(char)arg2 configuration:(id)arg3 responseModelBuilder:(id)arg4 ;
-(id)initWithScreenName:(id)arg1 polling:(char)arg2 configuration:(id)arg3 responseModelBuilder:(id)arg4 ;
