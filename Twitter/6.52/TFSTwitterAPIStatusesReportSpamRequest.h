...
+(id)HTTPMethod;
-(id)initWithStatusID:(id)arg1 reportAs:(unsigned)arg2 blockUser:(char)arg3 polling:(char)arg4 configuration:(id)arg5 responseModelBuilder:(id)arg6 ;
...
-(id)_reportAsParameterStringForReportSpamRequestType:(unsigned)arg1 ;
@end
