...
+(id)HTTPMethod;
-(id)initWithTweets:(id)arg1 prerollID:(id)arg2 dynamicPrerollType:(id)arg3 includeLongVideos:(char)arg4 polling:(char)arg5 configuration:(id)arg6 responseModelBuilder:(id)arg7 ;
