...
@class NSString, FBFormFieldsInputFormFieldsSELECTIONINTValue;

@interface FBFormFieldsInputFormFieldsSELECTIONINT : FBGraphQLInput {

	NSString* _formFieldId;
	NSString* _disableAutofill;
	FBFormFieldsInputFormFieldsSELECTIONINTValue* _value;
...
@property (nonatomic,copy) FBFormFieldsInputFormFieldsSELECTIONINTValue * value;              //@synthesize value=_value - In the implementation block
...
-(FBFormFieldsInputFormFieldsSELECTIONINTValue *)value;
-(void)setValue:(FBFormFieldsInputFormFieldsSELECTIONINTValue *)arg1 ;
@end
