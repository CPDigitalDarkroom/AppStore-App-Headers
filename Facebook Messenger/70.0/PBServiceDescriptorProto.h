...
@class NSString, PBServiceOptions, NSMutableArray, NSArray;
...
@property (retain) NSMutableArray * methodArray; 
@property (retain) PBServiceOptions * options; 
@property (readonly) NSArray * method; 
...
-(void)setMethodArray:(NSMutableArray *)arg1 ;
-(id)defaultInstance;
-(id)init;
...
-(NSString *)name;
-(void)setOptions:(PBServiceOptions *)arg1 ;
-(PBServiceOptions *)options;
-(NSArray *)method;
-(id)builder;
-(char)isInitialized;
