...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNContactImporterStoreWriting.h>

@class FBContactStore, NSString;

@interface MNContactImporterContactStoreWriteRunner : NSObject <FBSessionClassProvidable, MNContactImporterStoreWriting> {
