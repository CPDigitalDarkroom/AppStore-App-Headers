...
@property (nonatomic,readonly) char hasChargedCard;                                                       //@synthesize hasChargedCard=_hasChargedCard - In the implementation block
...
-(id)initWithAmountText:(id)arg1 recipientName:(id)arg2 hasDefaultCardOnFile:(char)arg3 hasChargedCard:(char)arg4 statusModel:(id)arg5 ;
-(NSString *)amountText;
@end
