...
@class NSString, NSArray, NSNumber, FBTargetingSpecInputTargetingSpecGeoLocations;

@interface FBTargetingSpecInputTargetingSpec : FBGraphQLInput {
	...
	NSNumber* _ageMax;
	NSNumber* _ageMin;
	FBTargetingSpecInputTargetingSpecGeoLocations* _geoLocations;
...
@property (nonatomic,copy) FBTargetingSpecInputTargetingSpecGeoLocations * geoLocations;              //@synthesize geoLocations=_geoLocations - In the implementation block
...
-(FBTargetingSpecInputTargetingSpecGeoLocations *)geoLocations;
-(void)setGeoLocations:(FBTargetingSpecInputTargetingSpecGeoLocations *)arg1 ;
-(NSArray *)interestIds;
