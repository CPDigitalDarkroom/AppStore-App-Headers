...
@interface FBPhotoSwipableFilterIpadExperimentContext : FBExperimentContext {
	...
	char _enabled;
	char _autoEnhanceDefault;

}

@property (nonatomic,readonly) char enabled;                         //@synthesize enabled=_enabled - In the implementation block
@property (nonatomic,readonly) char autoEnhanceDefault;              //@synthesize autoEnhanceDefault=_autoEnhanceDefault - In the implementation block
+(char)allowUserInterfaceIdiom:(int)arg1 ;
+(id)universeName;
+(id)parameterConfigurations;
-(char)autoEnhanceDefault;
-(char)enabled;
@end
