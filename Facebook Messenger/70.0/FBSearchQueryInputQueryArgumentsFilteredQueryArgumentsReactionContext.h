...
@class NSArray, NSString, FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextViewerCoordinates, FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextNtContext;

@interface FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContext : FBGraphQLInput {
	...
	NSString* _sessionId;
	FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextViewerCoordinates* _viewerCoordinates;
	FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextNtContext* _ntContext;
...
@property (nonatomic,copy) FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextViewerCoordinates * viewerCoordinates;              //@synthesize viewerCoordinates=_viewerCoordinates - In the implementation block
@property (nonatomic,copy) FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextNtContext * ntContext;                              //@synthesize ntContext=_ntContext - In the implementation block
-(void)setViewerCoordinates:(FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextViewerCoordinates *)arg1 ;
-(void)setSurface:(NSString *)arg1 ;
-(const FBGraphQLInputField*)fieldsMetadataWithOutLength:(out int*)arg1 ;
-(FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextViewerCoordinates *)viewerCoordinates;
-(NSArray *)unitStyles;
...
-(FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextNtContext *)ntContext;
-(void)setNtContext:(FBSearchQueryInputQueryArgumentsFilteredQueryArgumentsReactionContextNtContext *)arg1 ;
