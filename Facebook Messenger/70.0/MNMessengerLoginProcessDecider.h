...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNLoginProcessDeciding.h>
...
-(id)initWithAuthManager:(id)arg1 loggedInUserInfoManagerProvider:(id)arg2 ;
@end
