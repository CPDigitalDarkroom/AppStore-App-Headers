...
@class FBMUser, FBMemPeerToPeerPlatformContext;

@interface FBPaymentsCheckoutFlowContextData : FBValueObject <NSCopying> {
...
-(id)initWithPaymentRecipient:(id)arg1 platformContext:(id)arg2 ;
