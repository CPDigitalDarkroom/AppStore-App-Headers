...
@class NSArray, NSString, FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoDataCallToAction;

@interface FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoData : FBGraphQLInput {
	...
	FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoDataCallToAction* _callToAction;
...
@property (nonatomic,copy) FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoDataCallToAction * callToAction;              //@synthesize callToAction=_callToAction - In the implementation block
-(FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoDataCallToAction *)callToAction;
-(NSString *)videoId;
-(NSString *)imageURLString;
-(void)setImageURLString:(NSString *)arg1 ;
-(const FBGraphQLInputField*)fieldsMetadataWithOutLength:(out int*)arg1 ;
-(void)setImageHash:(NSString *)arg1 ;
-(void)setCallToAction:(FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoDataCallToAction *)arg1 ;
