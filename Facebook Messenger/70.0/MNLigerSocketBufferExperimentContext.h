...
@interface MNLigerSocketBufferExperimentContext : FBExperimentContext {
...
@property (nonatomic,readonly) int sendBuffer;              //@synthesize sendBuffer=_sendBuffer - In the implementation block
