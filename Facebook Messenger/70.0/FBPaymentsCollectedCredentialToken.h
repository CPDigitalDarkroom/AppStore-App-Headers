...
@property (nonatomic,readonly) int credentialTokenType;                      //@synthesize credentialTokenType=_credentialTokenType - In the implementation block
...
-(int)credentialTokenType;
-(NSString *)credentialToken;
-(id)initWithCredentialTokenType:(int)arg1 credentialToken:(id)arg2 ;
@end
