...
@interface MNComposerExtensionEventExperimentContext : FBExperimentContext {
...
@property (nonatomic,copy,readonly) NSString * URLScheme;              //@synthesize URLScheme=_URLScheme - In the implementation block
