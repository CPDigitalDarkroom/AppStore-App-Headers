...
@class NSArray, NSString, FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextViewerCoordinates, FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextNtContext;

@interface FBGametimeLeagueReactionUnitsInputTriggerDataReactionContext : FBGraphQLInput {
	...
	NSString* _sessionId;
	FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextViewerCoordinates* _viewerCoordinates;
	FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextNtContext* _ntContext;
...
@property (nonatomic,copy) FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextViewerCoordinates * viewerCoordinates;              //@synthesize viewerCoordinates=_viewerCoordinates - In the implementation block
@property (nonatomic,copy) FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextNtContext * ntContext;                              //@synthesize ntContext=_ntContext - In the implementation block
-(void)setViewerCoordinates:(FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextViewerCoordinates *)arg1 ;
-(void)setSurface:(NSString *)arg1 ;
-(const FBGraphQLInputField*)fieldsMetadataWithOutLength:(out int*)arg1 ;
-(FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextViewerCoordinates *)viewerCoordinates;
-(NSArray *)unitStyles;
...
-(FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextNtContext *)ntContext;
-(void)setNtContext:(FBGametimeLeagueReactionUnitsInputTriggerDataReactionContextNtContext *)arg1 ;
