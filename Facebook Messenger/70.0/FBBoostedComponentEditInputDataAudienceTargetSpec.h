...
@class NSString, NSArray, NSNumber, FBBoostedComponentEditInputDataAudienceTargetSpecGeoLocations;

@interface FBBoostedComponentEditInputDataAudienceTargetSpec : FBGraphQLInput {
	...
	NSNumber* _ageMax;
	NSNumber* _ageMin;
	FBBoostedComponentEditInputDataAudienceTargetSpecGeoLocations* _geoLocations;
...
@property (nonatomic,copy) FBBoostedComponentEditInputDataAudienceTargetSpecGeoLocations * geoLocations;              //@synthesize geoLocations=_geoLocations - In the implementation block
...
-(FBBoostedComponentEditInputDataAudienceTargetSpecGeoLocations *)geoLocations;
-(void)setGeoLocations:(FBBoostedComponentEditInputDataAudienceTargetSpecGeoLocations *)arg1 ;
-(NSArray *)interestIds;
