...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNCDNPhotoDownloadRunnerListening.h>
...
-(void)photoRunnerDidFinishWithPhoto:(id)arg1 forPhotoDownloadRequest:(id)arg2 forDownloadId:(unsigned long)arg3 isFinalResponse:(char)arg4 ;
-(void)photoRunnerDidFailToDownloadPhotoWithError:(id)arg1 forPhotoDownloadRequest:(id)arg2 forDownloadId:(unsigned long)arg3 ;
@end
