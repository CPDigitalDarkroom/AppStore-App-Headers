...
@interface MNCameraLivePreviewView : UIView <MNCameraViewLayout> {
	...
	char _showInstructionLabelBelowBounds;
	float _transitionProgress;
	float _freezeImageRotationAngle;
	unsigned _layoutGravity;
	char _reverseLayoutOrder;
	float _instructionLabelRotationAngle;
	float _interfaceRotationAngle;
...
-(id)initWithFrame:(CGRect)arg1 enableVideo:(char)arg2 overlayView:(id)arg3 resizePreviewLayer:(char)arg4 showInstructionLabelBelowBounds:(char)arg5 ;
...
-(void)setInstructionLabelRotationAngle:(float)arg1 animated:(char)arg2 ;
-(void)setInstructionLabelRotationAngle:(float)arg1 ;
