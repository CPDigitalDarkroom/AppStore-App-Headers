...
@property (getter=isCompleted,nonatomic,readonly) char completed;                                          //@synthesize isCompleted=_isCompleted - In the implementation block
...
-(void)_openPlatformURL:(id)arg1 actionDidComplete:(char)arg2 ;
...
-(NSString *)cipherKey;
-(id)_jsonStringFromDictionary:(id)arg1 excludeBinaryData:(char)arg2 ;
