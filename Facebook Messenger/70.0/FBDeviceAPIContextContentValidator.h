...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBContentValidating.h>
...
-(char)validateContent:(id)arg1 responseProcessor:(id)arg2 error:(id*)arg3 ;
-(id)initWithBatchRequest:(id)arg1 ;
-(FBGraphBatchRequest *)batchRequest;
-(char)_isValidDeviceAPIResponse:(id)arg1 ;
@end
