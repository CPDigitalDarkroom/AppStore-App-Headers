...
@property (nonatomic,readonly) char shouldFetchMoreContacts;                       //@synthesize shouldFetchMoreContacts=_shouldFetchMoreContacts - In the implementation block
-(char)shouldFetchMoreContacts;
-(id)initWithSyncEvents:(id)arg1 context:(id)arg2 shouldFetchMoreContacts:(char)arg3 ;
