...
@interface FBAssetGeoCoderHelperDefaultRateLimiting : NSObject {
	...
	unsigned _maxRequestsPerDay;
	FBPreferences* _userPreferences;
	NSDate* _currentDate;
	unsigned _currentCount;
	char _needsPersisting;

}
-(id)initWithMaxRequestsPerDay:(unsigned)arg1 userPreferences:(id)arg2 ;
-(void)_resetKeysIfNeeded;
-(id)_todaysDate;
-(char)shouldGeoCoderHelperAllowAppleAPIRequest;
