...
@class NSString, FBEventUserBlockInputDataContext;

@interface FBEventUserBlockInputData : FBGraphQLInput {

	NSString* _clientMutationId;
	NSString* _actorId;
	NSString* _targetUserId;
	NSString* _blockType;
	FBEventUserBlockInputDataContext* _context;
...
@property (nonatomic,copy) FBEventUserBlockInputDataContext * context;              //@synthesize context=_context - In the implementation block
...
-(FBEventUserBlockInputDataContext *)context;
-(void)setContext:(FBEventUserBlockInputDataContext *)arg1 ;
-(NSString *)blockType;
@end
