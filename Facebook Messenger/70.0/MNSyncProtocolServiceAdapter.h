...
@class FBMSPCoordinator, FBMNetworkProtocolController, NSString;

@interface MNSyncProtocolServiceAdapter : NSObject <MNServiceControllable> {
...
-(id)initWithSyncProtocolCoordinator:(id)arg1 networkProtocolController:(id)arg2 ;
-(void)stop;
-(void)start:(id)arg1 ;
-(void)handleIdle;
@end
