...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/HMNavigationController.h>

@interface FBHummingbirdCustomNavigationController : HMNavigationController {
