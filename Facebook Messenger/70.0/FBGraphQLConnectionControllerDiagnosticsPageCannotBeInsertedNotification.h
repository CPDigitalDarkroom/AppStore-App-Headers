...
@class FBGraphQLConnectionLocation, FBGraphQLConnectionStoreLocation, NSString, NSDictionary;
...
@property (nonatomic,copy,readonly) FBGraphQLConnectionStoreLocation * storeLocation;                     //@synthesize storeLocation=_storeLocation - In the implementation block
...
-(id)initWithPage:(id)arg1 location:(id)arg2 storeLocation:(id)arg3 originalRequestedLocation:(id)arg4 responseIndex:(unsigned)arg5 expectedResponseCount:(unsigned)arg6 networkLoadUUID:(id)arg7 responseUUID:(id)arg8 userInfo:(id)arg9 ;
