...
@class UIButton, MNBusinessNavigationHandler, MNBusinessCTAListenerAnnouncer, MNBusinessButtonViewModel, NSString;

@interface MNBusinessButtonView : UIView <MNBusinessView> {

	UIButton* _button;
	MNBusinessNavigationHandler* _navigationHandler;
	MNBusinessCTAListenerAnnouncer* _businessCTAAnnouncer;
...
-(id)initWithFrame:(CGRect)arg1 navigationHandler:(id)arg2 ;
-(void)emulateTap;
