...
@class NSString, NSData, FBStringWithRedactedDescription;

@interface FBMSecureThreadProperties : FBValueObject <NSCopying, NSCoding> {
...
-(id)initWithOtherUserFbId:(id)arg1 deviceId:(id)arg2 otherUserFingerprint:(id)arg3 codeName:(id)arg4 threadStatus:(unsigned)arg5 ;
