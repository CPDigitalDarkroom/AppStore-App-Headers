...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNContactSyncLegalDisclaimerTextViewDelegate.h>
...
-(id)initWithFrame:(CGRect)arg1 showsDisclaimerTextView:(char)arg2 ;
-(void)presentContactImportPrimer;
-(void)showLoadingIndication:(char)arg1 ;
-(void)showLoadingIndication:(char)arg1 animated:(char)arg2 ;
