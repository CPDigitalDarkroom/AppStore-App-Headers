...
@class MNNewThreadNavigationCoordinator, MNThreadNavigationCoordinator, NSString;

@interface MNThreadViewStatusManager : NSObject <FBSessionClassProvidable> {
...
-(id)initWithThreadNavigationCoordinator:(id)arg1 newThreadNavigationCoordinator:(id)arg2 ;
@end
