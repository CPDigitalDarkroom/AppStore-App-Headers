...
@interface FBMessageVideoAttachmentPreparationLogger : NSObject <FBMessageVideoAttachmentPreparationListener> {
...
-(void)_willBeginUploadWithContentSize:(unsigned)arg1 isResumed:(char)arg2 ;
