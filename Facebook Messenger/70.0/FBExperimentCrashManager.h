...
@interface FBExperimentCrashManager : NSObject {
	...
	char _allowForceConfigRefreshInDebugBuilds;
...
@property (assign,nonatomic) char allowForceConfigRefreshInDebugBuilds;                            //@synthesize allowForceConfigRefreshInDebugBuilds=_allowForceConfigRefreshInDebugBuilds - In the implementation block
...
-(char)allowForceConfigRefreshInDebugBuilds;
-(NSTimer *)crashTimer;
