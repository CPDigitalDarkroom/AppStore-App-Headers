...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNEditUsernameViewControllerDelegate.h>
...
@class MNSettingsTabConfiguration, MNNavigationCoordinator, FBAnalytics, FBMUser, NSString;
...
-(id)initWithSettingsTabConfiguration:(id)arg1 navigationCoordinator:(id)arg2 editUsernameViewControllerProvider:(id)arg3 analytics:(id)arg4 ;
