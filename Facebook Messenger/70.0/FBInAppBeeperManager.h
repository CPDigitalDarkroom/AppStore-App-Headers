...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBInAppBeeperContainerViewDelegate.h>
...
+(id)sharedInstance;
-(char)showBeeperForInAppContentView:(id)arg1 config:(id)arg2 ;
...
-(char)canShowBeeperWithPriority:(int)arg1 ;
-(char)_isBeeperShowing;
-(char)canShowBeeper;
