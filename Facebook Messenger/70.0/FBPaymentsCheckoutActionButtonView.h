...
@class UILabel, FBPaymentsLoadingStatusButton;

@interface FBPaymentsCheckoutActionButtonView : UIView {

	UILabel* _termsAndPoliciesLabel;
...
-(id)initWithLoadingIndicatorFactory:(id)arg1 termsAndPoliciesModel:(id)arg2 ;
