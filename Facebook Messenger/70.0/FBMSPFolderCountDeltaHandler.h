...
@class FBMSPFolderCountDeltaHandlerListenerAnnouncer, NSString;

@interface FBMSPFolderCountDeltaHandler : NSObject <FBSessionClassProvidable, MNMessagesSyncDeltaHandling> {
