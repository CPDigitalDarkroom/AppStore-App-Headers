...
@property (retain) PBDescriptorProtoExtensionRange * resultExtensionRange; 
...
-(char)hasStart;
-(char)hasEnd;
-(void)setResultExtensionRange:(PBDescriptorProtoExtensionRange *)arg1 ;
-(id)clearStart;
-(id)clearEnd;
-(PBDescriptorProtoExtensionRange *)resultExtensionRange;
-(id)clone;
