...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBNuxProvider.h>
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBClassProvidable.h>

@protocol FBProvider;
@class MNPushInstructionsController, MNQuickPromotionThreadListQPPresenter, MNQuickPromotionThreadViewQPPresenter, FBUserSession, MNQuickPromotionInterstitialDataSource, MNPhotoReminderInterstitialController, MNUniqueIDInterstitialController, MNPostFacebookDeactivationNuxController, NSString;
...
@interface MNNuxProvider : NSObject <FBNuxProvider, FBClassProvidable> {
	...
	MNPhotoReminderInterstitialController* _photoReminderInterstitialController;
