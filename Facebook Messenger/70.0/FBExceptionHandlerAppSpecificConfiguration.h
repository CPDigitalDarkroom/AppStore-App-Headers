...
@property (nonatomic,readonly) char uploadRecentLogs;                         //@synthesize uploadRecentLogs=_uploadRecentLogs - In the implementation block
...
-(id)initWithApplicationFBID:(id)arg1 bundleID:(id)arg2 localeIdentifier:(id)arg3 uploadRecentLogs:(char)arg4 reportPercentage:(double)arg5 ;
-(double)reportPercentage;
-(NSString *)applicationFBID;
-(char)uploadRecentLogs;
-(NSString *)bundleID;
