...
@class NSString, NSArray, FBBoostedComponentCreateInputDataCreativeObjectStorySpecLinkData, FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoData;
...
@interface FBBoostedComponentCreateInputDataCreativeObjectStorySpec : FBGraphQLInput {
	...
	FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoData* _videoData;
...
@property (nonatomic,copy) FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoData * videoData;              //@synthesize videoData=_videoData - In the implementation block
-(NSString *)pageId;
...
-(void)setVideoData:(FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoData *)arg1 ;
-(FBBoostedComponentCreateInputDataCreativeObjectStorySpecVideoData *)videoData;
@end
