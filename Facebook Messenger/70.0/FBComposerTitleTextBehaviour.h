...
@interface FBComposerTitleTextBehaviour : NSObject <NSCopying, NSCoding> {
	...
	NSString* _swappedWhenAuthorPublishingToOwnTimeline_titleWhenPostingRedSpaceOnlyToOwnTimeline;
...
+(id)swappedWhenAuthorPublishingToOwnTimelineWithTitleWhenPostingToOwnTimeline:(id)arg1 titleWhenPostingRedSpaceOnlyToOwnTimeline:(id)arg2 ;
