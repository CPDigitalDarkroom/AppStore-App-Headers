...
@protocol FBProvider;
@class MNPushInstructionsController, MNPhotoReminderInterstitialController, MNUniqueIDInterstitialController, FBUserSession, NSString;
...
-(id)initWithPushInstructionsController:(id)arg1 photoReminderInterstitialController:(id)arg2 uniqueIDIntersititalControllerProvider:(id)arg3 session:(id)arg4 ;
-(void)stop;
-(void)start:(id)arg1 ;
-(void)handleIdle;
@end
