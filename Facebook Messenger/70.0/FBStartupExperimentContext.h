...
@interface FBStartupExperimentContext : FBExperimentContext {
	...
	char _delayJewelController;

}

@property (nonatomic,readonly) char delayJewelController;              //@synthesize delayJewelController=_delayJewelController - In the implementation block
+(char)allowUserInterfaceIdiom:(int)arg1 ;
+(id)universeName;
+(id)parameterConfigurations;
-(char)delayJewelController;
@end
