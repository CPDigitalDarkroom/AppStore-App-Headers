...
@class NSString, FBFormFieldsInputFormFieldsCHECKBOXValue;

@interface FBFormFieldsInputFormFieldsCHECKBOX : FBGraphQLInput {

	NSString* _formFieldId;
	NSString* _disableAutofill;
	FBFormFieldsInputFormFieldsCHECKBOXValue* _value;
...
@property (nonatomic,copy) FBFormFieldsInputFormFieldsCHECKBOXValue * value;              //@synthesize value=_value - In the implementation block
...
-(FBFormFieldsInputFormFieldsCHECKBOXValue *)value;
-(void)setValue:(FBFormFieldsInputFormFieldsCHECKBOXValue *)arg1 ;
@end
