...
@class MNThreadViewModel, MNBlockFeatureConfiguration, MNBlockUserFullScreenViewController, MNNavigationCoordinator, NSString;
...
-(id)initWithBlockFeatureConfiguration:(id)arg1 blockUserViewController:(id)arg2 navigationCoordinator:(id)arg3 ;
