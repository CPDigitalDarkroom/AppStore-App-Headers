...
@class FBMThreadListFetcher, MNThreadListMetadataFetcher, FBMThreadSet, MNPendingRequestsStore, NSString;
...
-(id)initWithThreadListFetcher:(id)arg1 filteredThreadsMetaDataFetcher:(id)arg2 threadSet:(id)arg3 pendingRequestsStore:(id)arg4 ;
