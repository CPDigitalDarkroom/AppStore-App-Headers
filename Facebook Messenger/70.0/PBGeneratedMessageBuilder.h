...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/PBAbstractMessageBuilder.h>

@interface PBGeneratedMessageBuilder : PBAbstractMessageBuilder
-(void)checkInitialized;
-(id)mergeUnknownFields:(id)arg1 ;
-(id)setUnknownFields:(id)arg1 ;
-(char)parseUnknownField:(id)arg1 unknownFields:(id)arg2 extensionRegistry:(id)arg3 tag:(long)arg4 ;
