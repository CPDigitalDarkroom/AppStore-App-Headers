...
@property (nonatomic,readonly) char isWriteYourOwn;                        //@synthesize isWriteYourOwn=_isWriteYourOwn - In the implementation block
-(char)isWriteYourOwn;
-(id)initWithParticipantId:(id)arg1 isWriteYourOwn:(char)arg2 ;
