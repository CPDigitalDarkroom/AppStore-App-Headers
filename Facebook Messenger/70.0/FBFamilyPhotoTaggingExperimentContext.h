...
@interface FBFamilyPhotoTaggingExperimentContext : FBExperimentContext {
	...
	char _enabled;
	char _allowTaggingAnyPhoto;

}

@property (nonatomic,readonly) char enabled;                           //@synthesize enabled=_enabled - In the implementation block
@property (nonatomic,readonly) char allowTaggingAnyPhoto;              //@synthesize allowTaggingAnyPhoto=_allowTaggingAnyPhoto - In the implementation block
+(char)allowUserInterfaceIdiom:(int)arg1 ;
+(id)universeName;
+(id)parameterConfigurations;
-(char)allowTaggingAnyPhoto;
-(char)enabled;
@end
