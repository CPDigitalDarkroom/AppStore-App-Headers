...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBDidSendExceptionsHandlerProtocol.h>
...
@interface FBDidSendExceptionsHandler : NSObject <FBDidSendExceptionsHandlerProtocol> {
	...
	char _shouldShowCrashReportsUploadToast;
...
-(char)shouldShowCrashReportsUploadToast;
