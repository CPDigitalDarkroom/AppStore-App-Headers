...
@property (nonatomic,readonly) int itemsCount;                          //@synthesize itemsCount=_itemsCount - In the implementation block
...
-(id)initWithItemsCount:(int)arg1 sectionInsets:(UIEdgeInsets)arg2 ;
-(int)itemsCount;
