...
@class NSArray, NSString, FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextViewerCoordinates, FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextNtContext;

@interface FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContext : FBGraphQLInput {
	...
	NSString* _sessionId;
	FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextViewerCoordinates* _viewerCoordinates;
	FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextNtContext* _ntContext;
...
@property (nonatomic,copy) FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextViewerCoordinates * viewerCoordinates;              //@synthesize viewerCoordinates=_viewerCoordinates - In the implementation block
@property (nonatomic,copy) FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextNtContext * ntContext;                              //@synthesize ntContext=_ntContext - In the implementation block
-(void)setViewerCoordinates:(FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextViewerCoordinates *)arg1 ;
-(void)setSurface:(NSString *)arg1 ;
-(const FBGraphQLInputField*)fieldsMetadataWithOutLength:(out int*)arg1 ;
-(FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextViewerCoordinates *)viewerCoordinates;
-(NSArray *)unitStyles;
...
-(FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextNtContext *)ntContext;
-(void)setNtContext:(FBGametimeLeagueReactionSurfacesInputTriggerDataReactionContextNtContext *)arg1 ;
