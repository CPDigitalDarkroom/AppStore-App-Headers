...
@interface FBMediaGallerySwipeableFiltersExperimentContext : FBExperimentContext {
	...
	char _enabled;
	char _shouldShowFilterBar;

}

@property (nonatomic,readonly) char enabled;                          //@synthesize enabled=_enabled - In the implementation block
@property (nonatomic,readonly) char shouldShowFilterBar;              //@synthesize shouldShowFilterBar=_shouldShowFilterBar - In the implementation block
+(char)allowUserInterfaceIdiom:(int)arg1 ;
+(id)universeName;
+(id)parameterConfigurations;
-(char)shouldShowFilterBar;
-(char)enabled;
@end
