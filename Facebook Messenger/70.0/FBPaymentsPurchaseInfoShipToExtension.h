...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBPaymentsAddressListViewControllerPickerDelegate.h>
...
@interface FBPaymentsPurchaseInfoShipToExtension : NSObject <FBPaymentsAddressDataFetcherDelegate, FBPaymentsAddressFormViewControllerDelegate, FBPaymentsAddressListViewControllerPickerDelegate, FBPaymentsPurchaseInfoExtension> {

	FBUserSession* _session;
	FBPaymentsAddressDataFetcher* _addressDataFetcher;
	FBMemMailingAddress* _selectedAddress;
	char _isUpdatingAddress;
