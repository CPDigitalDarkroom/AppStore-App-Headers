...
@property (assign,nonatomic) char inPostConsumeState;                            //@synthesize inPostConsumeState=_inPostConsumeState - In the implementation block
-(void)setInPostConsumeState:(char)arg1 ;
-(char)inPostConsumeState;
