...
@property (nonatomic,readonly) char purchased;                                   //@synthesize purchased=_purchased - In the implementation block
-(NSString *)bubbleStyle;
-(NSDecimalNumber *)priceAmount;
-(id)initWithItemSuggestionId:(id)arg1 bubbleStyle:(id)arg2 item:(id)arg3 priceAmount:(id)arg4 priceCurrency:(id)arg5 formattedPrice:(id)arg6 purchased:(char)arg7 ;
