...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNMultipleUserRequestRunning.h>
...
-(void)_processResultForRequest:(unsigned long)arg1 listener:(id)arg2 usersByUserId:(id)arg3 pendingResponse:(id)arg4 loadingIndicatorKey:(id)arg5 fetcher:(id)arg6 didFail:(char)arg7 error:(id)arg8 ;
