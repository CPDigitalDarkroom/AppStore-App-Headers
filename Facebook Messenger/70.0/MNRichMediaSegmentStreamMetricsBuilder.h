...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNRichMediaUploadMetricsBuilder.h>

@interface MNRichMediaSegmentStreamMetricsBuilder : MNRichMediaUploadMetricsBuilder {
...
-(void)setNumOfSegments:(unsigned)arg1 ;
