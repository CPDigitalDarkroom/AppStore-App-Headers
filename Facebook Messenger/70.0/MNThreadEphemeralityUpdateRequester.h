...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNThreadEphemeralitySetting.h>
...
-(void)setEphemeralityForThread:(id)arg1 ephemerality:(int)arg2 originalEphemerality:(int)arg3 completion:(/*^block*/id)arg4 ;
