...
@interface MNWebViewControllerThemeConfigurer : NSObject <FBSessionClassProvidable, MNMessagesViewThemeUpdateListening> {
...
-(char)_shouldCustomize;
-(char)_isViewingThread;
