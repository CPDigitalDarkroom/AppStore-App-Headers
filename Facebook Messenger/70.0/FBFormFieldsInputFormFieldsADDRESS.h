...
@class NSString, FBFormFieldsInputFormFieldsADDRESSValue;

@interface FBFormFieldsInputFormFieldsADDRESS : FBGraphQLInput {

	NSString* _formFieldId;
	NSString* _disableAutofill;
	FBFormFieldsInputFormFieldsADDRESSValue* _value;
...
@property (nonatomic,copy) FBFormFieldsInputFormFieldsADDRESSValue * value;              //@synthesize value=_value - In the implementation block
...
-(FBFormFieldsInputFormFieldsADDRESSValue *)value;
-(void)setValue:(FBFormFieldsInputFormFieldsADDRESSValue *)arg1 ;
@end
