...
@property (nonatomic,readonly) unsigned assetType;                                  //@synthesize assetType=_assetType - In the implementation block
@property (nonatomic,readonly) double duration;                                     //@synthesize duration=_duration - In the implementation block
-(id)initWithMetadataDictionary:(id)arg1 assetType:(unsigned)arg2 duration:(double)arg3 ;
-(double)duration;
