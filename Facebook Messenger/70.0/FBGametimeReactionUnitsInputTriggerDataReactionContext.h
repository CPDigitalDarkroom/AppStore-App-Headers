...
@class NSArray, NSString, FBGametimeReactionUnitsInputTriggerDataReactionContextViewerCoordinates, FBGametimeReactionUnitsInputTriggerDataReactionContextNtContext;

@interface FBGametimeReactionUnitsInputTriggerDataReactionContext : FBGraphQLInput {
	...
	NSString* _sessionId;
	FBGametimeReactionUnitsInputTriggerDataReactionContextViewerCoordinates* _viewerCoordinates;
	FBGametimeReactionUnitsInputTriggerDataReactionContextNtContext* _ntContext;
...
@property (nonatomic,copy) FBGametimeReactionUnitsInputTriggerDataReactionContextViewerCoordinates * viewerCoordinates;              //@synthesize viewerCoordinates=_viewerCoordinates - In the implementation block
@property (nonatomic,copy) FBGametimeReactionUnitsInputTriggerDataReactionContextNtContext * ntContext;                              //@synthesize ntContext=_ntContext - In the implementation block
-(void)setViewerCoordinates:(FBGametimeReactionUnitsInputTriggerDataReactionContextViewerCoordinates *)arg1 ;
-(void)setSurface:(NSString *)arg1 ;
-(const FBGraphQLInputField*)fieldsMetadataWithOutLength:(out int*)arg1 ;
-(FBGametimeReactionUnitsInputTriggerDataReactionContextViewerCoordinates *)viewerCoordinates;
-(NSArray *)unitStyles;
...
-(FBGametimeReactionUnitsInputTriggerDataReactionContextNtContext *)ntContext;
-(void)setNtContext:(FBGametimeReactionUnitsInputTriggerDataReactionContextNtContext *)arg1 ;
