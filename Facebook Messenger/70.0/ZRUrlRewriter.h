...
+(char)URLMatchesBootstrapHost:(id)arg1 ;
...
+(char)_url:(id)arg1 isWhitelistedBySessions:(id)arg2 ;
+(void)_reportBadUrl:(id)arg1 lastDeactivatedSession:(id)arg2 lastReachabilityStatus:(id)arg3 ;
+(id)rewriteUrl:(id)arg1 thatMatches:(id)arg2 with:(id)arg3 matchCount:(unsigned*)arg4 ;
...
-(char)urlIsRewritable:(id)arg1 ;
-(char)shouldRewriteUrl:(id)arg1 ;
...
-(char)_urlShouldSkipRewrite:(id)arg1 withRewriteInfo:(id)arg2 ;
