...
@property (nonatomic,readonly) char canOpen;                         //@synthesize canOpen=_canOpen - In the implementation block
...
-(id)initWithCanOpen:(char)arg1 updatedTimestamp:(double)arg2 ;
-(char)canOpen;
@end
