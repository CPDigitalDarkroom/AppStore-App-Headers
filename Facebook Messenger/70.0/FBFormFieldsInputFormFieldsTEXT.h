...
@class NSString, FBFormFieldsInputFormFieldsTEXTValue;

@interface FBFormFieldsInputFormFieldsTEXT : FBGraphQLInput {

	NSString* _formFieldId;
	NSString* _disableAutofill;
	FBFormFieldsInputFormFieldsTEXTValue* _value;
...
@property (nonatomic,copy) FBFormFieldsInputFormFieldsTEXTValue * value;              //@synthesize value=_value - In the implementation block
...
-(FBFormFieldsInputFormFieldsTEXTValue *)value;
-(void)setValue:(FBFormFieldsInputFormFieldsTEXTValue *)arg1 ;
@end
