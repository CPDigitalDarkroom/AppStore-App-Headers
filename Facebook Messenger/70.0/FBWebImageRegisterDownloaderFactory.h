...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBWebImageDownloaderFactoryProtocol.h>
...
-(void)registerFunction:(/*function pointer*/void*)arg1 context:(id)arg2 forType:(id)arg3 ;
-(char)isTypeRegistered:(id)arg1 ;
-(id)init;
@end
