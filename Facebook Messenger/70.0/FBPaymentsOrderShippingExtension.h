...
@protocol FBPaymentsOrderSummaryExtensionDelegate, FBPaymentsOrderSummaryExtensionDataSource;
@class NSString;

@interface FBPaymentsOrderShippingExtension : NSObject <FBPaymentsOrderSummaryExtension> {
