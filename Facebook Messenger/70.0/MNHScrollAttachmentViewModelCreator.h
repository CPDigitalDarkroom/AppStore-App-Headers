...
@class MNConfigManager, MNAttachmentStyleRendererManager, NSString;

@interface MNHScrollAttachmentViewModelCreator : NSObject <FBSessionClassProvidable, MNAttachmentStyleViewModelCreator> {
