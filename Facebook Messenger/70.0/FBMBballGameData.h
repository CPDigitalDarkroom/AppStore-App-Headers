...
@interface FBMBballGameData : FBValueObject <NSCopying> {
...
@property (nonatomic,readonly) int highScore;                                //@synthesize highScore=_highScore - In the implementation block
-(int)highScore;
-(NSString *)highScoreUserId;
-(id)initWithHighScoreUserId:(id)arg1 highScore:(int)arg2 ;
@end
