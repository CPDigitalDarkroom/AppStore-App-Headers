...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNTabBarIconDecorating.h>

@class NSString;

@interface MNTabBarIconDecorator : NSObject <MNTabBarIconDecorating> {

	char _shouldUseSettingsTab;
...
-(id)initWithShouldUseSettingsTab:(char)arg1 ;
