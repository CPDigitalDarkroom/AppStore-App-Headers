...
@property (nonatomic,readonly) char expectCompleteness;                 //@synthesize expectCompleteness=_expectCompleteness - In the implementation block
-(NSArray *)gatekeepers;
-(id)initWithGatekeepers:(id)arg1 expectCompleteness:(char)arg2 ;
-(char)expectCompleteness;
@end
