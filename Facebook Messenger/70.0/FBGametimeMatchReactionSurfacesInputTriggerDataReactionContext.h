...
@class NSArray, NSString, FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextViewerCoordinates, FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextNtContext;

@interface FBGametimeMatchReactionSurfacesInputTriggerDataReactionContext : FBGraphQLInput {
	...
	NSString* _sessionId;
	FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextViewerCoordinates* _viewerCoordinates;
	FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextNtContext* _ntContext;
...
@property (nonatomic,copy) FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextViewerCoordinates * viewerCoordinates;              //@synthesize viewerCoordinates=_viewerCoordinates - In the implementation block
@property (nonatomic,copy) FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextNtContext * ntContext;                              //@synthesize ntContext=_ntContext - In the implementation block
-(void)setViewerCoordinates:(FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextViewerCoordinates *)arg1 ;
-(void)setSurface:(NSString *)arg1 ;
-(const FBGraphQLInputField*)fieldsMetadataWithOutLength:(out int*)arg1 ;
-(FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextViewerCoordinates *)viewerCoordinates;
-(NSArray *)unitStyles;
...
-(FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextNtContext *)ntContext;
-(void)setNtContext:(FBGametimeMatchReactionSurfacesInputTriggerDataReactionContextNtContext *)arg1 ;
