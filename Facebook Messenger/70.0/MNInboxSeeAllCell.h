...
@property (assign,nonatomic) unsigned numberOfAllItems;                          //@synthesize numberOfAllItems=_numberOfAllItems - In the implementation block
-(unsigned)numberOfAllItems;
-(MNThreadCellLayout *)threadCellLayout;
-(void)setThreadCellLayout:(MNThreadCellLayout *)arg1 ;
-(void)setNumberOfAllItems:(unsigned)arg1 ;
-(void)layoutSubviews;
