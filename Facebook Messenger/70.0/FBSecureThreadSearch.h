...
@class FBSecureThreadSearchFetcher, FBAnalytics, NSString, NSArray, FBContactSearchQuery;

@interface FBSecureThreadSearch : NSObject <FBContactsSearch> {

	FBSecureThreadSearchFetcher* _fetcher;
...
-(id)initWithSecureThreadSearchFetcher:(id)arg1 ;
-(id)_secureThreadResultForRowIndex:(int)arg1 ;
-(void)secureThreadSearchFetcherDidFetchResults:(id)arg1 ;
