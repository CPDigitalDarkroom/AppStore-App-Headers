...
@class NSString, FBFormFieldsInputFormFieldsDATETIMEValue;

@interface FBFormFieldsInputFormFieldsDATETIME : FBGraphQLInput {

	NSString* _formFieldId;
	NSString* _disableAutofill;
	FBFormFieldsInputFormFieldsDATETIMEValue* _value;
...
@property (nonatomic,copy) FBFormFieldsInputFormFieldsDATETIMEValue * value;              //@synthesize value=_value - In the implementation block
...
-(FBFormFieldsInputFormFieldsDATETIMEValue *)value;
-(void)setValue:(FBFormFieldsInputFormFieldsDATETIMEValue *)arg1 ;
@end
