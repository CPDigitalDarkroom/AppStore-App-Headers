...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBMQTTClientDelegate.h>
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBMQTTNetworkStatusChangedListening.h>
...
@class NSString, NSTimer, NSMutableDictionary, NSMutableSet, NSObject, NSNotificationCenter, FBMQTTExperiments, FBWhistleCellRadioChangeMonitor, JSONDecoder, FBDNSCacheHost, FBMQTTCredentialHashProcessor, NSNumber, FBMQTTNetworkStatusMonitor, FBMQTTChannelEndpointCapabilities, FBMQTTSocketConfig, FBMQTTClientCapabilities, NSDictionary, NSDate;
...
@interface FBMQTTClientManager : NSObject <FBMQTTClientDelegate, FBMQTTNetworkStatusChangedListening, FBMQTTInterface> {
	...
	char _credentialsAndUserAgentFetched;
	char _sslDisabled;
	char _encodingDisabled;
	char _isDNSCacheEnabled;
	...
	char _isFirstConnect;
	unsigned long long _lastBackgroundChange;
	unsigned long long _lastReachabilityChange;
	unsigned _prevReachabilityFlags;
	...
	char _autoOnlineOnForeground;
	NSNumber* _currentEncodedReferenceCode;
	int _currentConnMessageId;
...
-(void)updateOnlineStatus:(char)arg1 ;
...
-(void)_postConnectivityNotification:(int)arg1 networkStatus:(int)arg2 ;
...
-(void)_publishNetworkOutgoingEvent:(id)arg1 topic:(id)arg2 ;
...
-(id)_removeListenerWithBackgroundPolicy:(unsigned)arg1 ;
-(id)_addListenersWithBackgroundPolicy:(unsigned)arg1 ;
-(void)publishForegroundState:(char)arg1 subscribeTopics:(id)arg2 unsubscribeTopics:(id)arg3 ;
-(int)bgPingState;
...
-(char)_isAuthenticationFailure:(id)arg1 ;
-(void)_publishCombinedForegroundState:(char)arg1 subscribeTopics:(id)arg2 unsubscribeTopics:(id)arg3 ;
...
-(void)_removeListenerIfNeeded:(id)arg1 afterHandlingMessage:(char)arg2 ;
-(int)_keepAliveTimeoutForForegroundState:(char)arg1 ;
...
-(void)networkStatusChangedFrom:(int)arg1 to:(int)arg2 ;
