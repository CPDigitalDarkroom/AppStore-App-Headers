...
@property (nonatomic,readonly) unsigned handlerOptions;                                         //@synthesize handlerOptions=_handlerOptions - In the implementation block
-(id)initWithRequestId:(unsigned long)arg1 specificMessageQuery:(id)arg2 configuration:(id)arg3 handlerOptions:(unsigned)arg4 ;
-(unsigned)handlerOptions;
