...
@property (nonatomic,readonly) SCD_Struct_FB51 time;                      //@synthesize time=_time - In the implementation block
...
-(id)initWithPerson:(id)arg1 faceBox:(id)arg2 videoAssetID:(id)arg3 time:(SCD_Struct_FB51)arg4 blurMeasure:(float)arg5 ;
-(char)isEqual:(id)arg1 ;
-(unsigned)hash;
-(SCD_Struct_FB51)time;
-(FBMemPerson *)person;
@end
