...
@interface FBPaymentsCheckoutExplanationInfoConfiguration : FBValueObject <NSCopying> {
	...
	unsigned _displayPolicy;
	FBPaymentsCheckoutExplanationInfoViewModel* _viewModel;

}

@property (nonatomic,readonly) unsigned displayPolicy;                                                   //@synthesize displayPolicy=_displayPolicy - In the implementation block
...
-(id)initWithDisplayPolicy:(unsigned)arg1 viewModel:(id)arg2 ;
-(unsigned)displayPolicy;
