...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBComposerPrivacySettingFetcher.h>
...
-(void)fetchPrivacySettingsForPrivacySettingLoadType:(unsigned)arg1 completionHandler:(/*^block*/id)arg2 errorHandler:(/*^block*/id)arg3 ;
