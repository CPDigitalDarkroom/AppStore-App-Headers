...
@property (nonatomic,readonly) char isDeactivatedOnFacebook;              //@synthesize isDeactivatedOnFacebook=_isDeactivatedOnFacebook - In the implementation block
-(unsigned)hashDynamic;
-(BOOL)isEqualDynamic:(id)arg1 ;
-(char)isEmployee;
-(char)isDeactivatedOnFacebook;
-(id)initWithUser:(id)arg1 isEmployee:(char)arg2 isDeactivatedOnFacebook:(char)arg3 ;
-(FBMUser *)user;
@end
