...
@class NSNumber, FBLocationUpdateInputDataCellInfoScanResultsCdmaInfoBaseStationCoordinates;

@interface FBLocationUpdateInputDataCellInfoScanResultsCdmaInfo : FBGraphQLInput {

	NSNumber* _baseStationId;
	FBLocationUpdateInputDataCellInfoScanResultsCdmaInfoBaseStationCoordinates* _baseStationCoordinates;
	NSNumber* _networkId;
	NSNumber* _systemId;
...
@property (nonatomic,copy) FBLocationUpdateInputDataCellInfoScanResultsCdmaInfoBaseStationCoordinates * baseStationCoordinates;              //@synthesize baseStationCoordinates=_baseStationCoordinates - In the implementation block
...
-(FBLocationUpdateInputDataCellInfoScanResultsCdmaInfoBaseStationCoordinates *)baseStationCoordinates;
-(void)setBaseStationCoordinates:(FBLocationUpdateInputDataCellInfoScanResultsCdmaInfoBaseStationCoordinates *)arg1 ;
-(NSNumber *)networkId;
