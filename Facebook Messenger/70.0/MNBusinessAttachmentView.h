...
@class MNBusinessStackedContainerView, MNBusinessNavigationHandler, MNAdsImpressionLogger, FBMessengerPageSubscriptionLogger, MNBusinessAttachmentViewModel, NSString;
...
@interface MNBusinessAttachmentView : UIControl <MNAttachmentView> {
	...
	FBMessengerPageSubscriptionLogger* _pageSubscriptionLogger;
...
-(id)initWithFrame:(CGRect)arg1 imageDownloader:(id)arg2 navigationHandler:(id)arg3 adsImpressionLogger:(id)arg4 pageSubscriptionLogger:(id)arg5 ;
