...
@interface MNMessagesSyncAudioMetadata : NSObject <TBase, NSCoding> {
	...
	char __isVoicemail;
	char __isVoicemail_isset;

}

@property (assign,setter=setIsVoicemail:,getter=isVoicemail,nonatomic) char isVoicemail; 
...
-(id)initWithIsVoicemail:(char)arg1 ;
-(char)isVoicemailIsSet;
