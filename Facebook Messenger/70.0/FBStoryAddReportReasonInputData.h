...
@interface FBStoryAddReportReasonInputData : FBGraphQLInput {
...
@property (nonatomic,copy) NSString * reportReason;                  //@synthesize reportReason=_reportReason - In the implementation block
...
-(void)setReportReason:(NSString *)arg1 ;
