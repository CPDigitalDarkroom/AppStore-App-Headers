...
@class FBMPersonIdentityTypeProperties, FBMPageIdentityTypeProperties;

@interface FBMUserIdentityTypeProperties : NSObject <NSCopying, NSCoding> {
...
-(void)matchPersonProperties:(/*^block*/id)arg1 pageProperties:(/*^block*/id)arg2 ;
