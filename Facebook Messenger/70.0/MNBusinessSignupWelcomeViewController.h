...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNBusinessSignupWelcomeViewDelegate.h>
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNBusinessSignupFetcherDelegate.h>
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/MNBusinessSignupViewControllerDelegate.h>
...
@class FBNetworkImageView, FBImageDownloader, FBUserSession, NSString, MNBusinessSignupViewControllerFactory, MNBusinessSignupWelcomeView, MNBusinessSignupFetcher, FBMemMNCommerceNewUserSignup, MNBusinessSignupWelcomeExperimentContext, MNBusinessSignupWelcomeUberPersonalizedExperimentContext, MNBusinessSignupWelcomeLyftPersonalizedExperimentContext;
...
-(void)_login;
-(void)_signup;
-(void)signupWelcomeView:(id)arg1 didProceedIsLogin:(char)arg2 ;
