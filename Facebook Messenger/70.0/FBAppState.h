...
@property (nonatomic,readonly) int applicationTerminationState;                                     //@synthesize applicationTerminationState=_applicationTerminationState - In the implementation block
...
-(int)applicationTerminationState;
