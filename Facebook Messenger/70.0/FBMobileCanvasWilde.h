...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBMobileCanvas.h>
...
@property (nonatomic,readonly) char disablePullToRefresh; 
-(char)handlePossibleBridgeRequestURL:(id)arg1 ;
-(id)initWithDialog:(id)arg1 appSessionController:(id)arg2 session:(id)arg3 ;
-(char)disablePullToRefresh;
@end
