...
@property (nonatomic,readonly) char shouldHandleLongPress;                  //@synthesize shouldHandleLongPress=_shouldHandleLongPress - In the implementation block
-(id)initWithText:(id)arg1 helpButtonText:(id)arg2 helpLink:(id)arg3 termButtonText:(id)arg4 termLink:(id)arg5 shouldHandleLongPress:(char)arg6 ;
-(char)shouldHandleLongPress;
-(NSURL *)helpLink;
-(NSURL *)termLink;
