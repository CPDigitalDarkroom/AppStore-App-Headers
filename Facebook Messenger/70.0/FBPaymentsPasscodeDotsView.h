...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBPaymentsPasscodeInputViewDelegate.h>
...
@interface FBPaymentsPasscodeDotsView : UIView <FBPaymentsPasscodeInputViewDelegate> {
	...
	unsigned _numberOfPasscodeDigits;
	unsigned _numberOfPasscodeDigitsEntered;
...
-(id)initWithFrame:(CGRect)arg1 numberOfPasscodeDigits:(unsigned)arg2 ;
-(void)resetPasscode;
-(void)_setupDotImages;
-(void)_setNumberOfDigitsEntered:(unsigned)arg1 ;
