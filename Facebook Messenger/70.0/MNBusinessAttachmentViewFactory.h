...
@class FBImageDownloader, MNBusinessPlugin, MNAdsImpressionLogger, FBMessengerPageSubscriptionLogger, NSString;

@interface MNBusinessAttachmentViewFactory : NSObject <FBSessionClassProvidable, MNAttachmentStyleViewFactory> {
