...
-(char)renameFromMarker:(int)arg1 withInstanceKey:(int)arg2 toMarkerId:(int)arg3 withInstanceKey:(int)arg4 ;
...
-(char)isMarkerOn:(int)arg1 instanceKey:(int)arg2 ;
-(id)init;
@end
