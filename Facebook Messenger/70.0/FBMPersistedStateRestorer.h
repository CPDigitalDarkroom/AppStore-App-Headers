...
@class FBMThreadSet, FBMPinnedGroupsManager, FBMFetchedThreadKeySet, MNThreadListContinuityTracker, NSString;
...
-(id)initWithThreadSet:(id)arg1 pinnedGroupsManager:(id)arg2 fetchedThreadKeySet:(id)arg3 threadMessageCache:(id)arg4 threadSummaryCache:(id)arg5 threadListContinuityTracker:(id)arg6 ;
