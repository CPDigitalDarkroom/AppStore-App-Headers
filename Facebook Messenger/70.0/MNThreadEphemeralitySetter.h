...
@interface MNThreadEphemeralitySetter : NSObject <FBSessionClassProvidable> {
...
-(void)setEphemeralityForThread:(id)arg1 ephemerality:(int)arg2 originalEphemerality:(int)arg3 ;
...
-(void)_ephemeralitySetterDidFinishWithSuccess:(char)arg1 ;
