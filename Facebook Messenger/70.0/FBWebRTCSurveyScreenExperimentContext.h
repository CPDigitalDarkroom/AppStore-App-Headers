...
@interface FBWebRTCSurveyScreenExperimentContext : FBExperimentContext {
...
@property (nonatomic,readonly) int t_index;                           //@synthesize t_index=_t_index - In the implementation block
@property (nonatomic,readonly) int s_index;                           //@synthesize s_index=_s_index - In the implementation block
