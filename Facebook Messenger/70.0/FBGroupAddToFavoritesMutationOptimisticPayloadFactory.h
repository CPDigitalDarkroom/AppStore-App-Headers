...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBBookmarkAddToFavoritesMutationOptimisticPayloadFactoryProtocol.h>
...
-(id)_optimisticPayload:(char)arg1 isHidden:(char)arg2 ;
