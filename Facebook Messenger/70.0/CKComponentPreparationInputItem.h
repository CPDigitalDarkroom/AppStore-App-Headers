...
-(id)initWithReplacementModel:(id)arg1 lifecycleManager:(id)arg2 constrainedSize:(CKSizeRange)arg3 oldSize:(CGSize)arg4 UUID:(id)arg5 sourceIndexPath:(id)arg6 destinationIndexPath:(id)arg7 changeType:(unsigned)arg8 passthrough:(char)arg9 context:(id)arg10 ;
