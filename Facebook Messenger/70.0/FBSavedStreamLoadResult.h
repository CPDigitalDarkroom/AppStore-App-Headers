...
#import <MessengerCompressed-iphoneos-arm64,iphoneos-armv7/FBStreamLoadResult.h>
...
-(id)initWithStartCursor:(id)arg1 endCursor:(id)arg2 hasNextPage:(char)arg3 connectionPage:(id)arg4 ;
@end
