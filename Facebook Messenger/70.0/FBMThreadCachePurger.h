...
@class FBMThreadSet, MNThreadListContinuityTracker, NSString;

@interface FBMThreadCachePurger : NSObject <FBSessionClassProvidable> {
...
-(id)initWithThreadSet:(id)arg1 threadListContinuityTracker:(id)arg2 authManager:(id)arg3 ;
