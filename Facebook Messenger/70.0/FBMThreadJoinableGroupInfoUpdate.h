...
@interface FBMThreadJoinableGroupInfoUpdate : NSObject <NSCopying, NSCoding> {

	unsigned _subtype;
	unsigned _updateJoinableMode_joinableMode;
	NSString* _updateJoinableMode_joinableLink;
	unsigned _updateApprovalMode_approvalMode;
...
+(id)updateJoinableModeWithJoinableMode:(unsigned)arg1 joinableLink:(id)arg2 ;
+(id)updateApprovalModeWithApprovalMode:(unsigned)arg1 ;
