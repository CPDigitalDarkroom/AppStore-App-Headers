...
@class NSString, FBCommerceProductItemCreateInputDataProductItemPrice, NSNumber, NSArray;

@interface FBCommerceProductItemCreateInputData : FBGraphQLInput {
	...
	FBCommerceProductItemCreateInputDataProductItemPrice* _productItemPrice;
	NSString* _currency;
	NSNumber* _price;
	NSArray* _imageIds;
	NSString* _groupId;
...
@property (nonatomic,copy) FBCommerceProductItemCreateInputDataProductItemPrice * productItemPrice;              //@synthesize productItemPrice=_productItemPrice - In the implementation block
...
-(FBCommerceProductItemCreateInputDataProductItemPrice *)productItemPrice;
-(NSString *)pageId;
...
-(void)setProductItemPrice:(FBCommerceProductItemCreateInputDataProductItemPrice *)arg1 ;
-(NSArray *)imageIds;
