...
@interface FBLocalDashboardSectionInputQueryParamsFiltersAgeRange : FBGraphQLInput {
...
@property (nonatomic,copy) NSNumber * min;              //@synthesize min=_min - In the implementation block
