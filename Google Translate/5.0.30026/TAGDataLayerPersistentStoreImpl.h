...
@property (assign) unsigned maxNumStoredItems;                          //@synthesize maxNumStoredItems=_maxNumStoredItems - In the implementation block
...
-(void)setMaxNumStoredItems:(unsigned)arg1 ;
-(void)dealloc;
-(id)init;
