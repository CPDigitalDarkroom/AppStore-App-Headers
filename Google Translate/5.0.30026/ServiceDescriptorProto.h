...
@class NSString, PBMutableArray, ServiceOptions;
...
@property (nonatomic,retain) PBMutableArray * methodArray; 
@property (assign,nonatomic) char hasStreamArray; 
@property (nonatomic,retain) PBMutableArray * streamArray; 
@property (assign,nonatomic) char hasOptions; 
@property (nonatomic,retain) ServiceOptions * options; 
+(id)descriptor;
@end
