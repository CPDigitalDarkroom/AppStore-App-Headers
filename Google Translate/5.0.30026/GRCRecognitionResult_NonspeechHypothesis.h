...
@interface GRCRecognitionResult_NonspeechHypothesis : PBGeneratedMessage

@property (assign,nonatomic) char hasHypothesis; 
@property (nonatomic,retain) GRCHypothesis * hypothesis; 
