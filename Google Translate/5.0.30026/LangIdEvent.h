...
@interface LangIdEvent : PBGeneratedMessage
...
@property (assign,nonatomic) char hasLanguageClassificationArray; 
@property (nonatomic,retain) PBMutableArray * languageClassificationArray; 
+(id)descriptor;
@end
