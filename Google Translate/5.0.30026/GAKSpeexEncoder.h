...
@interface GAKSpeexEncoder : GAKAudioSource <GAKAudioSink> {
	...
	const SpeexMode* _speexMode;
	long _speexQuality;
	GAKDataPacketizer* _packetizer;
	char _includeHeaderByte;
	SpeexBits* _speexBits;
	void* _encoderState;
	long _bitRate;
	long _framesPerPacket;
	long _bytesPerPacket;
	AudioBufferList* _encodedAudioBufferList;
...
-(id)initWithSampleRate:(unsigned long)arg1 formatFlags:(unsigned long)arg2 ;
-(unsigned)encodePacket:(void*)arg1 intoData:(id)arg2 ;
