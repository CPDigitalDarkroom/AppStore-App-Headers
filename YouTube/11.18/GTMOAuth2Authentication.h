...
#import <YouTube/GTMFetcherAuthorizationProtocol.h>

@protocol GTMHTTPFetcherServiceProtocol;
@class NSString, NSMutableDictionary, NSURL, NSDate, NSDictionary, GTMHTTPFetcher, NSMutableArray, SSOIdentity, NSNumber;
