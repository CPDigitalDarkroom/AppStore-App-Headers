...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, PBMutableArray, NSData, YTIMenuSupportedRenderers;

@interface YTIGridMoviePlaylistRenderer : PBGeneratedMessage
