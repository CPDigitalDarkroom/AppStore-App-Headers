...
@class YTIFormattedString, YTIIcon, YTIThumbnailDetails, YTINavigationEndpoint;

@interface YTICreatorStudioSectionRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasOpensNewWindow; 
@property (assign,nonatomic) char opensNewWindow; 
+(id)descriptor;
@end
