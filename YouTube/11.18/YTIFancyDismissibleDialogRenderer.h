...
@interface YTIFancyDismissibleDialogRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasConfirmServiceEndpoint; 
@property (nonatomic,retain) YTIServiceEndpoint * confirmServiceEndpoint; 
