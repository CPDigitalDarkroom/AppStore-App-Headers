...
@class NSString, YTIPlaylistThumbnailSupportedRenderers, YTIFormattedString, YTINavigationEndpoint, PBMutableArray, YTIMenuSupportedRenderers, NSData;

@interface YTIGamingPlaylistRenderer : PBGeneratedMessage
