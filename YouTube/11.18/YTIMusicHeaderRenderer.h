...
@class YTIFormattedString, YTIMusicHeaderSupportedRenderers, NSData;

@interface YTIMusicHeaderRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIMusicHeaderSupportedRenderers * header; 
