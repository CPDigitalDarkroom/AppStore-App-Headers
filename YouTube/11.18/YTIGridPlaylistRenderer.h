...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, NSData, PBMutableArray, YTIPlaylistThumbnailSupportedRenderers, YTIMenuSupportedRenderers, YTIGridPlaylistRenderer_GridPlaylistOfflineabilitySupportedRenderers, YTILikeButtonSupportedRenderers, YTIAssociatedGameSupportedRenderers;

@interface YTIGridPlaylistRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIGridPlaylistRenderer_GridPlaylistOfflineabilitySupportedRenderers * offlineability; 
