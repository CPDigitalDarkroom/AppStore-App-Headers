...
@class YTIResponseContext, YTIConversationSwitcherSectionSupportedRenderers, NSString;

@interface YTIGetConversationSwitcherResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIConversationSwitcherSectionSupportedRenderers * contents; 
