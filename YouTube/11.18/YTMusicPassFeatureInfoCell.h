...
@class YTIMusicPassFeatureInfoRenderer, YTMusicPassFeatureInfoView, NSString;

@interface YTMusicPassFeatureInfoCell : YTCollectionViewCell <YTFormattedStringLabelDelegate, YTFeedViewCellProtocol, YTThumbnailMapping> {
