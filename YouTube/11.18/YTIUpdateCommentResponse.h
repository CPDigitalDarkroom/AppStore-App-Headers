...
@class YTIResponseContext, YTIUpdateCommentResponseSupportedRenderers, NSString;

@interface YTIUpdateCommentResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIUpdateCommentResponseSupportedRenderers * contents; 
