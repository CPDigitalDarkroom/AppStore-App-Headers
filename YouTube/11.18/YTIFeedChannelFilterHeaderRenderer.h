...
@class YTIFormattedString, YTINavigationEndpoint, YTIThumbnailDetails, YTIFeedChannelFilterHeaderActionSupportedRenderers, NSData;

@interface YTIFeedChannelFilterHeaderRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIFeedChannelFilterHeaderActionSupportedRenderers * action; 
