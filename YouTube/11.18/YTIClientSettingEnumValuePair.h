...
@class YTIClientSettingItem, NSString;

@interface YTIClientSettingEnumValuePair : PBGeneratedMessage

@property (assign,nonatomic) char hasClientSettingEnum; 
@property (nonatomic,retain) YTIClientSettingItem * clientSettingEnum; 
