...
@class YTPlaylistThumbnailView, YTFormattedStringLabel, UILabel, YTIGridRadioRenderer, NSString;

@interface YTGridRadioView : YTGridBaseView <YTAccessibilityMixinEmbedder> {

	YTPlaylistThumbnailView* _thumbnailView;
	YTFormattedStringLabel* _titleLabel;
	YTFormattedStringLabel* _subtitleLabel;
	UILabel* _separatorLabel;
	YTIGridRadioRenderer* _entry;
