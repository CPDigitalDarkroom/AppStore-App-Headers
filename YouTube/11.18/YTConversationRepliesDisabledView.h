...
@class YTFormattedStringLabel, YTImageView, UIView, NSString;

@interface YTConversationRepliesDisabledView : UIView <YTFormattedStringLabelDelegate, YTResponder> {

	YTFormattedStringLabel* _repliesDisabledLabel;
	YTImageView* _repliesDisabledImage;
