...
@class YTIFormattedString, YTIMusicCardShelfHeaderChannelThumbnailSupportedRenderers, NSData;

@interface YTIMusicCardShelfHeaderChannelRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIMusicCardShelfHeaderChannelThumbnailSupportedRenderers * thumbnail; 
