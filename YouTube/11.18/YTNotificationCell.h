...
@class YTINotificationRenderer, YTImageView, YTVideoThumbnailView, YTButton, YTFormattedStringLabel, UILongPressGestureRecognizer, NSString;

@interface YTNotificationCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTCellActionProtocol, YTThumbnailMapping> {
...
+(CGSize)actionButtonPaddingSize;
+(CGSize)channelThumbnailSize;
+(CGSize)channelThumbnailPaddingSize;
+(CGSize)actionButtonSize;
+(float)cellBorderPadding;
