...
@interface YTISearchSuggestionRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasSuggestion; 
@property (nonatomic,retain) YTIFormattedString * suggestion; 
