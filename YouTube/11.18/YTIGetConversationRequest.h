...
#import <YouTube/YTConversationRequestProtocol.h>

@class NSString, YTIInnerTubeContext, NSData;

@interface YTIGetConversationRequest : PBGeneratedMessage <YTConversationRequestProtocol>
...
@property (assign,nonatomic) char hasLatestPostTimestamp; 
@property (assign,nonatomic) long long latestPostTimestamp; 
