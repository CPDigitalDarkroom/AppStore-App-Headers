...
@class YTIEmergencyOneboxRenderer, YTFormattedStringLabel, UIImageView, YTEmergencySupportActionView, NSString;

@interface YTEmergencyOneboxCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTCellActionProtocol> {
...
@property (nonatomic,readonly) YTEmergencySupportActionView * firstOptionView;               //@synthesize firstOptionView=_firstOptionView - In the implementation block
@property (nonatomic,readonly) YTEmergencySupportActionView * secondOptionView;              //@synthesize secondOptionView=_secondOptionView - In the implementation block
...
-(YTEmergencySupportActionView *)firstOptionView;
-(YTEmergencySupportActionView *)secondOptionView;
