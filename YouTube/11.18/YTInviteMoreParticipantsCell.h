...
@class YTIInviteMoreParticipantsRenderer, YTFormattedStringLabel, YTImageView, UITapGestureRecognizer, NSString;

@interface YTInviteMoreParticipantsCell : YTCollectionViewCell <YTFeedViewCellProtocol> {

	YTIInviteMoreParticipantsRenderer* _inviteMoreRenderer;
	YTFormattedStringLabel* _addPeopleLabel;
	YTImageView* _addPeopleImage;
