...
@interface YTIAutomixPlaylistVideoRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasHideTopSeparator; 
@property (assign,nonatomic) char hideTopSeparator; 
+(id)descriptor;
@end
