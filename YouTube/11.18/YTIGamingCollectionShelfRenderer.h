...
@class NSData, PBMutableArray, YTIButtonSupportedRenderers;

@interface YTIGamingCollectionShelfRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasShowAllButton; 
@property (nonatomic,retain) YTIButtonSupportedRenderers * showAllButton; 
+(id)descriptor;
@end
