...
@class UIView, YTLocator, NSString;

@interface YTVideoInfoCardContentCell : YTBaseInfoCardContentCell <YTCellActionProtocol, YTFeedViewCellProtocol, YTStyleable, YTThumbnailMapping> {
