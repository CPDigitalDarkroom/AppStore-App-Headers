...
@interface YTIGetHistoryPausedStateResponse : PBGeneratedMessage
...
@property (assign,nonatomic) char hasWatchHistoryPaused; 
@property (assign,nonatomic) char watchHistoryPaused; 
@property (assign,nonatomic) char hasSearchHistoryPaused; 
