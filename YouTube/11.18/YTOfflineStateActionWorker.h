...
@class YTOfflineVideoController, NSString;
...
-(id)initWithOfflineVideoController:(id)arg1 offlineConfig:(id)arg2 ;
-(void)refreshVideoForVideo:(id)arg1 completionBlock:(/*^block*/id)arg2 errorBlock:(/*^block*/id)arg3 ;
-(void)refreshPlayerResponseForVideo:(id)arg1 completionBlock:(/*^block*/id)arg2 errorBlock:(/*^block*/id)arg3 ;
@end
