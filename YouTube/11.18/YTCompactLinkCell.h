...
@class YTICompactLinkRenderer, YTImageView, YTFormattedStringLabel, YTUnseenItemCountView, NSString;

@interface YTCompactLinkCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTThumbnailMapping> {
