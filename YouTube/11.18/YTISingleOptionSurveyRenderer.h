...
@class YTIFormattedString, PBMutableArray, NSData, YTIServiceEndpoint, NSString, YTISurveyOrientation;

@interface YTISingleOptionSurveyRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasFollowUpSurveyUrl; 
@property (nonatomic,retain) NSString * followUpSurveyUrl; 
