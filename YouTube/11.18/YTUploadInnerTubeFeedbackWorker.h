...
@class YTUploadInnerTubeFeedbackController, NSString;

@interface YTUploadInnerTubeFeedbackWorker : YTBaseWorker <YTUploadInnerTubeCoordinatorObserver, YTUploadInnerTubeFeedbackControllerObserver, YTWorker> {
...
-(id)initWithCoordinator:(id)arg1 feedbackController:(id)arg2 ;
-(id)init;
@end
