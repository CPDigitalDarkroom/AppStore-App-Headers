...
@class YTIFormattedString, PBMutableArray, YTIAutomixTunerSettingSupportedContinuations, NSData;

@interface YTIAutomixTunerSettingRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasSettingLabel; 
@property (nonatomic,retain) YTIFormattedString * settingLabel; 
@property (assign,nonatomic) char hasTunerImagesArray; 
@property (nonatomic,retain) PBMutableArray * tunerImagesArray; 
...
@property (nonatomic,retain) YTIAutomixTunerSettingSupportedContinuations * continuation; 
