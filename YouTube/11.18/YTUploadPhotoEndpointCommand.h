...
@class YTPhotoUploadController, NSString;

@interface YTUploadPhotoEndpointCommand : NSObject <YTServiceEndpointCommand> {
...
-(id)initWithPhotoUploadController:(id)arg1 ;
