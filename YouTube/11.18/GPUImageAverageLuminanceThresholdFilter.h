...
@class GPUImageLuminosity, GPUImageLuminanceThresholdFilter;
...
@property (assign,nonatomic) float thresholdMultiplier;              //@synthesize thresholdMultiplier=_thresholdMultiplier - In the implementation block
-(void)setThresholdMultiplier:(float)arg1 ;
