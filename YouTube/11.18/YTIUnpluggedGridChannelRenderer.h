...
@class YTIThumbnailDetails, YTIThumbnailPresentationStyleEnum, NSString, YTIFormattedString, YTINavigationEndpoint, NSData;

@interface YTIUnpluggedGridChannelRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnail; 
@property (nonatomic,retain) YTIThumbnailDetails * thumbnail; 
@property (assign,nonatomic) char hasThumbnailPresentationStyle; 
@property (nonatomic,retain) YTIThumbnailPresentationStyleEnum * thumbnailPresentationStyle; 
...
@property (assign,nonatomic) char hasTitleBannerColor; 
@property (nonatomic,retain) NSString * titleBannerColor; 
