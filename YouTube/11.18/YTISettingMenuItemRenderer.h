...
@class NSString, YTIServiceEndpoint, NSData;

@interface YTISettingMenuItemRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasUpdateServiceEndpoint; 
@property (nonatomic,retain) YTIServiceEndpoint * updateServiceEndpoint; 
