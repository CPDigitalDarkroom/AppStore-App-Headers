...
@class YTIPendingConnectionRenderer, YTConnectionView, NSString;

@interface YTPendingConnectionCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTThumbnailMapping> {

	YTIPendingConnectionRenderer* _entry;
