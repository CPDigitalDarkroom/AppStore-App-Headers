...
@class YTIMusicWideArtistRadioThumbnailSupportedRenderers, YTIFormattedString, YTINavigationEndpoint, YTIMenuSupportedRenderers, NSData;

@interface YTIMusicWideArtistRadioRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnailRenderer; 
@property (nonatomic,retain) YTIMusicWideArtistRadioThumbnailSupportedRenderers * thumbnailRenderer; 
