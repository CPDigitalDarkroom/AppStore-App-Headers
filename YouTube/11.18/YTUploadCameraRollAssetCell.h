...
@class YTVideoThumbnailView, YTUploadCameraRollAsset, YTIFormattedString, UIImageView, NSString;

@interface YTUploadCameraRollAssetCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTResponder> {
