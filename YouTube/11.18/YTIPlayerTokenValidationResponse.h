...
@interface YTIPlayerTokenValidationResponse : PBGeneratedMessage
...
@property (assign,nonatomic) char hasValidationResult; 
@property (assign,nonatomic) int validationResult; 
+(id)descriptor;
@end
