...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, PBMutableArray, YTIMenuSupportedRenderers, YTIAssociatedGameSupportedRenderers, NSData, YTIGamingVideoRenderer_GamingVideoOfflineabilitySupportedRenderers;

@interface YTIGamingVideoRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIGamingVideoRenderer_GamingVideoOfflineabilitySupportedRenderers * offlineability; 
