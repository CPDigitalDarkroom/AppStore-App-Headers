...
@interface YTIFlowProgressMeterRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasSectionLength; 
@property (assign,nonatomic) unsigned sectionLength; 
@property (assign,nonatomic) char hasProgress; 
@property (assign,nonatomic) unsigned progress; 
