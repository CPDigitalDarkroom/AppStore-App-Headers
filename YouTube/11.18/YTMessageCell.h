...
@class UIImageView, YTFormattedStringLabel, YTIMessageRenderer, NSString;

@interface YTMessageCell : YTCollectionViewCell <YTFormattedStringLabelDelegate, YTFeedViewCellProtocol, YTResponder, YTCellLinkProtocol> {
...
-(void)layoutSubviewsWithIcon;
-(void)layoutSubviewsWithoutIcon;
-(float)heightWithIconForWidth:(float)arg1 ;
-(float)heightWithoutIconForWidth:(float)arg1 ;
-(float)heightOfTextAndSubtextForWidth:(float)arg1 ;
