...
@class YTIAddConnectionRenderer, UIImageView, YTFormattedStringLabel, UITapGestureRecognizer, NSString;

@interface YTShareAddContactCell : YTCollectionViewCell <YTFeedViewCellProtocol> {
