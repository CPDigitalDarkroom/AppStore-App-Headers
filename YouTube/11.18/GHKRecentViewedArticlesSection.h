...
@class NSArray, GHKSessionDataManager;

@interface GHKRecentViewedArticlesSection : NSObject {

	NSArray* _recentlyViewedObjects;
...
-(id)sectionHeaderObject;
-(id)recentlyViewedContentViewObjectWithTitle:(id)arg1 ;
-(id)init;
@end
