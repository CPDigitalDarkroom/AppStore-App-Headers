...
@interface YTIPlaylistAddToOptionRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasContainsSelectedVideos; 
@property (assign,nonatomic) int containsSelectedVideos; 
