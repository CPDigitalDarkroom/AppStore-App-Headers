...
#import <YouTube/YTInfoCardAdChoicesProtocol.h>
#import <YouTube/YTInfoCardViewProtocol.h>

@class YTIShoppingAdInfoCardContentRenderer, YTFormattedStringLabel, YTButton, YTImageView, YTInfoCardMetadataView, UITapGestureRecognizer, NSString;
