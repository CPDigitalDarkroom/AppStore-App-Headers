...
@class YTIResponseContext, NSString, YTIChannelDescriptionErrorSupportedRenderers;

@interface YTIChannelDescriptionEditResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIChannelDescriptionErrorSupportedRenderers * error; 
+(id)descriptor;
@end
