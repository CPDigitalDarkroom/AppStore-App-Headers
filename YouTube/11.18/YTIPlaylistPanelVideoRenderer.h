...
@class NSString, YTIFormattedString, YTIThumbnailDetails, YTINavigationEndpoint, PBMutableArray, YTIPlaylistPanelVideoOfflineabilitySupportedRenderers, NSData, YTIMenuSupportedRenderers, YTIStandaloneBadgeSupportedRenderers;

@interface YTIPlaylistPanelVideoRenderer : PBGeneratedMessage <YTLiveVideoProtocol>
...
@property (assign,nonatomic) char hasIndexText; 
@property (nonatomic,retain) YTIFormattedString * indexText; 
...
@property (assign,nonatomic) char hasUnplayableText; 
@property (nonatomic,retain) YTIFormattedString * unplayableText; 
...
@property (nonatomic,retain) YTIPlaylistPanelVideoOfflineabilitySupportedRenderers * offlineability; 
...
+(id)playlistPanelVideoRendererWithOfflineVideo:(id)arg1 index:(unsigned)arg2 playlistID:(id)arg3 offlineMode:(char)arg4 ;
+(id)playlistPanelVideoRendererWithVideo:(id)arg1 index:(unsigned)arg2 playlistID:(id)arg3 offlineMode:(char)arg4 ;
+(id)descriptor;
-(char)isLive;
@end
