...
@class YTINavigationEndpoint, YTIFormattedString, NSData;

@interface YTIUnlimitedSettingCategoryEntryRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasIsPromo; 
@property (assign,nonatomic) char isPromo; 
