...
@class YTIFormattedString, YTIThumbnailDetails, YTINavigationEndpoint, YTIButtonSupportedRenderers, NSData;

@interface YTIUnlimitedOfferModuleRenderer : PBGeneratedMessage
