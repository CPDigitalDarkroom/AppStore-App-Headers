...
@class YTIResponseContext, YTICommentsResponseSupportedRenderers, YTIContinuationSupportedRenderers, NSString;

@interface YTICommentsResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTICommentsResponseSupportedRenderers * contents; 
