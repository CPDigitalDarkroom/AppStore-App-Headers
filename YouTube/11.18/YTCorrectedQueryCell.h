...
@protocol YTCorrectedQuery, YTResponder, YTCellLinkDelegate;
@class YTFormattedStringLabel, NSString;

@interface YTCorrectedQueryCell : YTCollectionViewCell <YTFormattedStringLabelDelegate, YTFeedViewCellProtocol, YTResponder, YTCellLinkProtocol> {
