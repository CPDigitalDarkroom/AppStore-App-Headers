...
@class YTIFormattedString, YTINavigationEndpoint, NSData, NSString;

@interface YTIShareTargetRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasTargetId; 
@property (assign,nonatomic) int targetId; 
...
@property (assign,nonatomic) char hasServiceName; 
