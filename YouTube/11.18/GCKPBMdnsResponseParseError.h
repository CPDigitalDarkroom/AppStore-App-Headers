...
@interface GCKPBMdnsResponseParseError : GCKPB_PBGeneratedMessage

@property (assign,nonatomic) char hasSequenceNumber; 
@property (assign,nonatomic) int sequenceNumber; 
@property (assign,nonatomic) char hasResponseErrorCode; 
@property (assign,nonatomic) int responseErrorCode; 
+(id)descriptor;
@end
