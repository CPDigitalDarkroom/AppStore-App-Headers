...
@class YTIResponseContext, YTIGetConnectionInviteUrlResponseSupportedRenderers, NSString;

@interface YTIGetConnectionInviteUrlResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIGetConnectionInviteUrlResponseSupportedRenderers * contents; 
