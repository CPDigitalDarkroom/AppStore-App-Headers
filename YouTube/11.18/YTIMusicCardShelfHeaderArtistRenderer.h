...
@class YTIFormattedString, YTIMusicCardShelfHeaderArtistThumbnailSupportedRenderers, YTINavigationEndpoint, YTIButtonSupportedRenderers, NSData;

@interface YTIMusicCardShelfHeaderArtistRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIMusicCardShelfHeaderArtistThumbnailSupportedRenderers * thumbnail; 
