...
@class YTUploadInnerTubeTaskController, GOOAlertView, NSString;

@interface YTDeletePendingUploadEndpointCommand : NSObject <GOOAlertViewDelegate, YTServiceEndpointCommand> {
