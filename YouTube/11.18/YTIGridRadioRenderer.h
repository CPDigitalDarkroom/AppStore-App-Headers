...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, NSData, PBMutableArray, YTIMenuSupportedRenderers;

@interface YTIGridRadioRenderer : PBGeneratedMessage
