...
@interface YTIOfflineResponse : PBGeneratedMessage
...
@property (assign,nonatomic) char hasPlaylistsArray; 
@property (nonatomic,retain) PBMutableArray * playlistsArray; 
