...
@interface YTIUnlimitedPageEmbedVideoRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasVideoId; 
@property (nonatomic,retain) NSString * videoId; 
@property (assign,nonatomic) char hasVideoAspectRatio; 
@property (assign,nonatomic) double videoAspectRatio; 
