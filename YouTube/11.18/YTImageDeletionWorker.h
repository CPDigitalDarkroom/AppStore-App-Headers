...
@class YTOfflineImageController, YTOfflinePlaylistController, YTOfflineVideoController, YTOfflineVideoListController, NSString;
...
-(id)initWithOfflineImageController:(id)arg1 offlinePlaylistController:(id)arg2 offlineVideoController:(id)arg3 offlineVideoListController:(id)arg4 ;
