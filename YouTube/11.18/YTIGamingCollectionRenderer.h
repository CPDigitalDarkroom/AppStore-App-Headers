...
@class NSData, PBMutableArray, YTIFormattedString, YTINavigationEndpoint;

@interface YTIGamingCollectionRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasTitleEndpoint; 
@property (nonatomic,retain) YTINavigationEndpoint * titleEndpoint; 
+(id)descriptor;
@end
