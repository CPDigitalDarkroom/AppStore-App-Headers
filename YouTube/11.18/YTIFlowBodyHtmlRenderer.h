...
@interface YTIFlowBodyHtmlRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasHtmlContent; 
@property (nonatomic,retain) NSString * htmlContent; 
@property (assign,nonatomic) char hasImagesArray; 
@property (nonatomic,retain) PBMutableArray * imagesArray; 
