...
@interface YTIBrowseSectionListReloadEndpoint : PBGeneratedMessage

@property (assign,nonatomic) char hasContinuation; 
@property (nonatomic,retain) YTIBrowseSectionListReloadSupportedContinuations * continuation; 
+(id)descriptor;
@end
