...
@interface YTIUnpluggedSelectableSectionRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasTitle; 
@property (nonatomic,retain) YTIFormattedString * title; 
@property (assign,nonatomic) char hasSelectorsArray; 
@property (nonatomic,retain) PBMutableArray * selectorsArray; 
