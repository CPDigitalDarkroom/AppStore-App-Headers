...
@class YTIThumbnailDetails, YTIFormattedString, YTIUnpluggedButtonSupportedRenderers, NSData;

@interface YTIUnpluggedSearchOneboxOtherCorpusRenderer : PBGeneratedMessage
