...
@class YTIUnlimitedPageHeaderRenderer, YTUnlimitedPageHeaderView, NSString;

@interface YTUnlimitedPageHeaderCell : YTCollectionViewCell <YTFormattedStringLabelDelegate, YTFeedViewCellProtocol, YTThumbnailMapping> {
