...
@class YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, NSData, YTIAssociatedGameSupportedRenderers;

@interface YTIGameSuggestionRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasDetails; 
@property (nonatomic,retain) YTIFormattedString * details; 
