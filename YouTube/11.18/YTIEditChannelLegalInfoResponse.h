...
@class YTIResponseContext, YTIChannelLegalTextErrorSupportedRenderers, NSString;

@interface YTIEditChannelLegalInfoResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIChannelLegalTextErrorSupportedRenderers * error; 
