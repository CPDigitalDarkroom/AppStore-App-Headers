...
@interface CSHMVideoCallData : PBGeneratedMessage

@property (assign,nonatomic) char hasPoolId; 
...
@property (assign,nonatomic) char hasCancelRequest; 
@property (assign,nonatomic) char cancelRequest; 
@property (assign,nonatomic) char hasIssueDescription; 
