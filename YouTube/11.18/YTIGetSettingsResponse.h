...
@class YTIResponseContext, NSString, PBMutableArray, YTISettingsResponseSupportedRenderers;

@interface YTIGetSettingsResponse : PBGeneratedMessage
...
@property (assign,nonatomic) char hasDrillDownItem; 
@property (nonatomic,retain) YTISettingsResponseSupportedRenderers * drillDownItem; 
+(id)descriptor;
-(PBMutableArray *)offlineItemsArray;
