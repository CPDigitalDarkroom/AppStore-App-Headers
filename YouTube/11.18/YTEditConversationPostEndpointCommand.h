...
@class YTConversationService, YTActionRouter, NSString;

@interface YTEditConversationPostEndpointCommand : NSObject <YTServiceEndpointCommand> {
...
-(id)initWithConversationService:(id)arg1 actionRouter:(id)arg2 ;
