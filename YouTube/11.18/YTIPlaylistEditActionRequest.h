...
@interface YTIPlaylistEditActionRequest : PBGeneratedMessage
...
@property (assign,nonatomic) char hasReturnedHeaderRendererType; 
@property (assign,nonatomic) int returnedHeaderRendererType; 
