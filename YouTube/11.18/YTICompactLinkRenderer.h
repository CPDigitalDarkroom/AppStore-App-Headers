...
@class YTIIcon, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, NSData;

@interface YTICompactLinkRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasSecondaryNotificationText; 
@property (nonatomic,retain) YTIFormattedString * secondaryNotificationText; 
+(id)descriptor;
@end
