...
@class YTICompactVideoRenderer, YTCompactVideoView, NSString;

@interface YTCompactVideoCell : YTCollectionViewCell <YTCellActionProtocol, YTFeedViewCellProtocol, YTOfflineVideoProgress, YTThumbnailMapping> {
