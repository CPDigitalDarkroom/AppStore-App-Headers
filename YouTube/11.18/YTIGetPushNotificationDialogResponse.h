...
@class YTIResponseContext, YTIPushNotificationDialogSupportedRenderers, NSString, NSData;

@interface YTIGetPushNotificationDialogResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIPushNotificationDialogSupportedRenderers * content; 
