...
@class NSString, YTIResponseContext, YTIConversationInviteMorePanelSupportedRenderers;

@interface YTIGetConversationInviteMorePanelResponse : PBGeneratedMessage <YTInnerTubeSectionRenderers>
...
@property (nonatomic,retain) YTIConversationInviteMorePanelSupportedRenderers * contents; 
