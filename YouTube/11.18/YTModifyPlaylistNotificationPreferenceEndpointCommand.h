...
@class YTNotificationService, YTActionRouter, NSString;

@interface YTModifyPlaylistNotificationPreferenceEndpointCommand : NSObject <YTServiceEndpointCommand> {
...
-(id)initWithActionRouter:(id)arg1 notificationService:(id)arg2 ;
