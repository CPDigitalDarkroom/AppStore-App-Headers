...
@class YTIFormattedString, YTIButtonSupportedRenderers, NSData, PBMutableArray;

@interface YTICompactOfferModuleRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasPurchaseMessage; 
@property (nonatomic,retain) YTIFormattedString * purchaseMessage; 
