...
@class YTIFormattedString, YTINavigationEndpoint, YTIThumbnailDetails, YTIIcon, NSData, YTITopicStyle;

@interface YTITopicRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasTopicIcon; 
@property (nonatomic,retain) YTIIcon * topicIcon; 
