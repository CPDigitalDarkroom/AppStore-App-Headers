...
@protocol YTShoppingCompanionAdView, YTResponder;
@class YTIShoppingCompanionAdRenderer, UIView, YTShoppingCompanionAdWhiteBackgroundView, YTShoppingCompanionAdGrayBackgroundView, NSString;

@interface YTShoppingCompanionAdCell : YTCollectionViewCell <YTCellActionProtocol, YTFeedViewCellProtocol, YTThumbnailMapping> {

	YTIShoppingCompanionAdRenderer* _companionAd;
	UIView*<YTShoppingCompanionAdView> _activeCompanionAdView;
	YTShoppingCompanionAdWhiteBackgroundView* _whiteBackgroundView;
	YTShoppingCompanionAdGrayBackgroundView* _grayBackgroundView;
