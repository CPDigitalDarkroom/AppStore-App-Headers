...
@class YTVideoThumbnailView, YTFormattedStringLabel, YTSubtitleView, YTIGridVideoRenderer, YTBadgesView, YTBadge, YTStandaloneBadgeView, NSArray, NSString;

@interface YTGridVideoView : YTGridBaseView <YTAccessibilityMixinEmbedder, YTSpaceCastAccelerable> {
...
-(id)metadataLayoutArray_regular;
-(id)metadataLayoutArray_compact;
