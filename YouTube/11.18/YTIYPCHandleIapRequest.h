...
@class YTIInnerTubeContext, YTIIapData, NSString;

@interface YTIYPCHandleIapRequest : PBGeneratedMessage

@property (assign,nonatomic) char hasContext; 
@property (nonatomic,retain) YTIInnerTubeContext * context; 
@property (assign,nonatomic) char hasIapData; 
@property (nonatomic,retain) YTIIapData * iapData; 
