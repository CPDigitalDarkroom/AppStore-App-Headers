...
@class YTIResponseContext, YTICreateCommentReplyResponseSupportedRenderers, NSString;

@interface YTICreateCommentReplyResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTICreateCommentReplyResponseSupportedRenderers * contents; 
