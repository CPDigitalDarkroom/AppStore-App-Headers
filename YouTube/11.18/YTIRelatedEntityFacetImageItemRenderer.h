...
@class YTIThumbnailDetails, YTINavigationEndpoint, NSData;

@interface YTIRelatedEntityFacetImageItemRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasThumbnailCropType; 
@property (assign,nonatomic) int thumbnailCropType; 
+(id)descriptor;
@end
