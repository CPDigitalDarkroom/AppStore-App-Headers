...
@class YTSharedStorageManager, NSString;

@interface YTUploadSharedStorageCleanupWorker : YTBaseWorker <YTWorker> {

	YTSharedStorageManager* _sharedStorageManager;
...
-(id)initWithSharedGroupName:(id)arg1 ;
@end
