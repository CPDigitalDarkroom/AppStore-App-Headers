...
@class YTINavigationEndpoint, NSString, YTIThumbnailDetails, PBMutableArray, NSData, YTIIcon, YTIFormattedString;

@interface YTIGuideCollectionEntryRenderer : PBGeneratedMessage
