...
@class YTIResponseContext, YTICreateCommentResponseSupportedRenderers, NSString;

@interface YTICreateCommentResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTICreateCommentResponseSupportedRenderers * contents; 
