...
@class YTIFormattedString, PBMutableArray, YTIButtonSupportedRenderers;

@interface YTICompactEpisodeRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasTitle; 
@property (nonatomic,retain) YTIFormattedString * title; 
@property (assign,nonatomic) char hasPlayAllText; 
@property (nonatomic,retain) YTIFormattedString * playAllText; 
...
@property (nonatomic,retain) YTIButtonSupportedRenderers * playAllButton; 
+(id)descriptor;
@end
