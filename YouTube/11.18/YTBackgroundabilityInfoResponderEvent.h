...
@property (nonatomic,readonly) YTIBackgroundabilityRenderer * backgroundabilityRenderer;              //@synthesize backgroundabilityRenderer=_backgroundabilityRenderer - In the implementation block
+(id)eventWithBackgroundabilityRenderer:(id)arg1 firstResponder:(id)arg2 ;
-(YTIBackgroundabilityRenderer *)backgroundabilityRenderer;
