...
@class YTIResponseContext, YTICommentRepliesResponseSupportedRenderers, YTIContinuationSupportedRenderers, NSString;

@interface YTICommentRepliesResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTICommentRepliesResponseSupportedRenderers * contents; 
