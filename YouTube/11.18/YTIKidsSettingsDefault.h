...
@interface YTIKidsSettingsDefault : PBGeneratedMessage

@property (assign,nonatomic) char hasClientSettingId; 
@property (nonatomic,retain) YTIClientSettingItem * clientSettingId; 
