...
@class YTIResponseContext, YTIPlaylistSettingsEditorSupportedRenderers, PBMutableArray, NSString, YTIContinuationSupportedRenderers, NSData;

@interface YTIGetPlaylistSettingsEditorResponse : PBGeneratedMessage

@property (assign,nonatomic) char hasResponseContext; 
@property (nonatomic,retain) YTIResponseContext * responseContext; 
@property (assign,nonatomic) char hasPlaylistSettingsEditor; 
@property (nonatomic,retain) YTIPlaylistSettingsEditorSupportedRenderers * playlistSettingsEditor; 
