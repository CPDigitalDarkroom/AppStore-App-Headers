...
@class YTIFormattedString, YTIThumbnailDetails, YTINavigationEndpoint, NSString, NSData;

@interface YTIWatchCardAlbumRenderer : PBGeneratedMessage <YTSmallArtistWatchCardListItem>
...
@property (nonatomic,retain) YTIFormattedString * year; 
