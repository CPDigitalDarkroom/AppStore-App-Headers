...
@class YTINavigationEndpoint, YTIFormattedString, YTIIcon, YTIShelfSupportedRenderers, NSData;

@interface YTIUnpluggedAssistantShelfCardRenderer : PBGeneratedMessage
