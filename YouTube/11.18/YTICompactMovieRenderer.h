...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, PBMutableArray, NSData, YTIMenuSupportedRenderers, YTIStandaloneBadgeSupportedRenderers;

@interface YTICompactMovieRenderer : PBGeneratedMessage
