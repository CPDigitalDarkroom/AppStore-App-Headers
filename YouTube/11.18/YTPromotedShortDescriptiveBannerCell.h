...
@class YTIPromotedShortDescriptiveBannerRenderer, YTAdSpamTouchGestureRecognizer, YTImageView, YTFormattedStringLabel, YTButton, UIButton, UILongPressGestureRecognizer, YTBadge, NSString;

@interface YTPromotedShortDescriptiveBannerCell : YTCollectionViewCell <UIGestureRecognizerDelegate, YTCellActionProtocol, YTCellLinkProtocol, YTFeedViewCellProtocol, YTResponder, YTThumbnailMapping> {

	YTIPromotedShortDescriptiveBannerRenderer* _renderer;
