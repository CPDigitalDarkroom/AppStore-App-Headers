...
@class YTISimpleTextSectionRenderer, YTSimpleTextSectionView, NSString;

@interface YTSimpleTextSectionCell : YTCollectionViewCell <YTFormattedStringLabelDelegate, YTFeedViewCellProtocol> {
