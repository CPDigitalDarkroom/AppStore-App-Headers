...
@class YTIFormattedString, PBMutableArray, YTIServiceEndpoint, NSData, YTIButtonSupportedRenderers, YTIThumbnailDetails, YTINavigationEndpoint;

@interface YTIFeedbackElicitationSingleQuestionRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasQuestion; 
@property (nonatomic,retain) YTIFormattedString * question; 
@property (assign,nonatomic) char hasResponsesArray; 
@property (nonatomic,retain) PBMutableArray * responsesArray; 
@property (assign,nonatomic) char hasCanSelectMultiple; 
@property (assign,nonatomic) char canSelectMultiple; 
