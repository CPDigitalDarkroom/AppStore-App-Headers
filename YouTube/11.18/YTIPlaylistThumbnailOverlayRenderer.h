...
@class YTIPlaylistThumbnailOverlayThumbnailSupportedRenderers, YTIFormattedString, YTIIcon, NSData;

@interface YTIPlaylistThumbnailOverlayRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnail; 
@property (nonatomic,retain) YTIPlaylistThumbnailOverlayThumbnailSupportedRenderers * thumbnail; 
