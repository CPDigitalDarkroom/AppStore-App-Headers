...
@interface YTIChipCloudRenderer : PBGeneratedMessage <YTInnerTubeSectionRenderer>

@property (readonly) unsigned hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
@property (assign,nonatomic) char hasChipsArray; 
@property (nonatomic,retain) PBMutableArray * chipsArray; 
@property (assign,nonatomic) char hasCollapsedRowCount; 
@property (assign,nonatomic) int collapsedRowCount; 
