...
@class YTIIcon, YTIServiceEndpoint, YTINavigationEndpoint, YTIAccessibilityData, NSData;

@interface YTIContentFabRenderer : PBGeneratedMessage
...
+(id)descriptor;
-(YTIIcon *)icon;
-(YTIAccessibilityData *)accessibility;
