...
@class YTIFormattedString, PBMutableArray, YTIThumbnailDetails, YTINavigationEndpoint;

@interface YTIMetadataWithImageRowRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasThumbnailEndpoint; 
@property (nonatomic,retain) YTINavigationEndpoint * thumbnailEndpoint; 
+(id)descriptor;
@end
