...
@class YTIFormattedString, YTIServiceEndpoint, YTINavigationEndpoint, YTIThumbnailDetails, YTIShareServiceIdentifier, NSData;

@interface YTIShareTargetServiceUpdateRenderer : PBGeneratedMessage
