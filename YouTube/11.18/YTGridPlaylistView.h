...
@class YTPlaylistThumbnailView, YTFormattedStringLabel, YTIGridPlaylistRenderer, NSString;

@interface YTGridPlaylistView : YTGridBaseView <YTAccessibilityMixinEmbedder> {

	YTPlaylistThumbnailView* _thumbnailView;
	YTFormattedStringLabel* _titleLabel;
	YTFormattedStringLabel* _subtitleLabel;
	YTIGridPlaylistRenderer* _entry;
