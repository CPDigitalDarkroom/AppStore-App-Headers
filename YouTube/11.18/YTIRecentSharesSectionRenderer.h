...
@class NSString, YTIFormattedString, PBMutableArray, NSData;

@interface YTIRecentSharesSectionRenderer : PBGeneratedMessage <YTInnerTubeSectionRenderer>
...
@property (assign,nonatomic) char hasRecentSharesArray; 
@property (nonatomic,retain) PBMutableArray * recentSharesArray; 
