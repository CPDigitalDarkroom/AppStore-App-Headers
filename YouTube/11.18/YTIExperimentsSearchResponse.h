...
@class YTIResponseContext, NSString, YTIExperimentsListResponseSupportedRenderers;

@interface YTIExperimentsSearchResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIExperimentsListResponseSupportedRenderers * content; 
+(id)descriptor;
@end
