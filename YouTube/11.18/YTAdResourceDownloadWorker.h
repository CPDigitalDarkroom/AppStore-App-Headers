...
@class YTOfflineAdPlaylistController, YTOfflineAdResourceController, NSString;
...
-(id)initWithOfflineAdPlaylistController:(id)arg1 offlineAdResourceController:(id)arg2 ;
