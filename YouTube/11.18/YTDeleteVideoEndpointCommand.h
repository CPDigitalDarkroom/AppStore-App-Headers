...
@class YTDeleteVideoService, GOOAlertView, NSString;

@interface YTDeleteVideoEndpointCommand : NSObject <GOOAlertViewDelegate, YTServiceEndpointCommand> {
...
-(id)initWithDeleteVideoService:(id)arg1 ;
