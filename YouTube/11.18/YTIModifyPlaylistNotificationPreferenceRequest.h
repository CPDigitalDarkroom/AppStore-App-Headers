...
@interface YTIModifyPlaylistNotificationPreferenceRequest : PBGeneratedMessage
...
@property (assign,nonatomic) char hasNotificationsEnabledDeviceLevel; 
@property (assign,nonatomic) char notificationsEnabledDeviceLevel; 
+(id)descriptor;
@end
