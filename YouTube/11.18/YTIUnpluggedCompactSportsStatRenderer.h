...
@interface YTIUnpluggedCompactSportsStatRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIFormattedString * value; 
@property (assign,nonatomic) char hasCaption; 
@property (nonatomic,retain) YTIFormattedString * caption; 
