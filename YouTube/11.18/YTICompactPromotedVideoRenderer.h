...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, NSData, PBMutableArray, YTIMenuSupportedRenderers, YTICompactPromotedVideoRenderer_CompactPromotedVideoOfflineabilitySupportedRenderers, YTICompactPromotedVideoCTASupportedRenderers;

@interface YTICompactPromotedVideoRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTICompactPromotedVideoRenderer_CompactPromotedVideoOfflineabilitySupportedRenderers * offlineability; 
...
@property (nonatomic,retain) YTICompactPromotedVideoCTASupportedRenderers * ctaRenderer; 
