...
@class YTIResponseContext, YTINavigationEndpoint, NSString, PBMutableArray;

@interface YTISendShareResponse : PBGeneratedMessage
...
@property (assign,nonatomic) char hasConversationRenderersArray; 
@property (nonatomic,retain) PBMutableArray * conversationRenderersArray; 
@property (assign,nonatomic) char hasNewConversationItemsArray; 
@property (nonatomic,retain) PBMutableArray * newConversationItemsArray; 
+(id)descriptor;
@end
