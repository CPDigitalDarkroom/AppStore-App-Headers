...
@class NSString, NSData, YTIFormattedString;

@interface YTINextContinuationData : PBGeneratedMessage
...
+(id)descriptor;
-(id)setClickTrackingParams:(NSData *)arg1 ;
-(id)setContinuation:(NSString *)arg1 ;
@end
