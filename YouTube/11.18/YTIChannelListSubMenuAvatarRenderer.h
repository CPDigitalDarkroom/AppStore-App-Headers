...
@class YTIThumbnailDetails, YTINavigationEndpoint, NSData, YTIAccessibilitySupportedDatas, YTIChannelListSubMenuAvatarHintSupportedRenderers;

@interface YTIChannelListSubMenuAvatarRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIChannelListSubMenuAvatarHintSupportedRenderers * hint; 
+(id)descriptor;
@end
