...
@class YTIFormattedString, NSString, YTIButtonSupportedRenderers, NSData;

@interface YTISettingTextRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasPrefilledText; 
