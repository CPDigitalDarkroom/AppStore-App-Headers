...
@interface YTIOfflinePlaylistSyncCheckResponse : PBGeneratedMessage

@property (assign,nonatomic) char hasResponseContext; 
@property (nonatomic,retain) YTIResponseContext * responseContext; 
@property (assign,nonatomic) char hasOfflinePlaylistSyncCheckDatasArray; 
@property (nonatomic,retain) PBMutableArray * offlinePlaylistSyncCheckDatasArray; 
