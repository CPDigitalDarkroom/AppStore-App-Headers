...
#import <YouTube/GCKCastSecureSocketDelegate.h>
#import <YouTube/GCKCastChannelHandler.h>
#import <YouTube/GCKDeviceAuthChannelDelegate.h>
#import <YouTube/GCKReceiverControlChannelDelegate.h>
#import <YouTube/GCKHeartbeatChannelDelegate.h>
...
@interface GCKDeviceManager : NSObject <GCKCastSecureSocketDelegate, GCKCastChannelHandler, GCKDeviceAuthChannelDelegate, GCKReceiverControlChannelDelegate, GCKHeartbeatChannelDelegate> {
	...
	int _connectionSession;
	int _applicationConnectionSession;
...
@property (nonatomic,copy) NSString * hashedDeviceID;                                                   //@synthesize hashedDeviceID=_hashedDeviceID - In the implementation block
...
-(char)sendTextMessage:(id)arg1 withNamespace:(id)arg2 ;
-(char)sendTextMessage:(id)arg1 withNamespace:(id)arg2 toDestinationID:(id)arg3 ;
-(char)sendBinaryMessage:(id)arg1 withNamespace:(id)arg2 ;
-(char)sendBinaryMessage:(id)arg1 withNamespace:(id)arg2 toDestinationID:(id)arg3 ;
...
-(char)connectToApplication:(id)arg1 ;
...
-(char)clearStopState;
-(char)sendMessageWithNamespace:(id)arg1 toDestinationID:(id)arg2 stringPayload:(id)arg3 binaryPayload:(id)arg4 ;
...
-(void)setHashedDeviceID:(NSString *)arg1 ;
