...
@class YTOfflineRefreshService, YTOfflineVideoController, NSTimer, YTIOfflineRefreshContinuation, NSDate, NSString;

@interface YTOfflineRefreshWorker : YTBaseWorker <YTOfflineVideoControllerObserver, YTWorker> {
...
-(id)initWithOfflineRefreshService:(id)arg1 offlineVideoController:(id)arg2 offlineConfig:(id)arg3 ;
...
-(char)useContinuation;
-(id)newOfflineRefreshRequestForContinuation:(id)arg1 ;
-(void)processOfflineRefreshResponse:(id)arg1 responseDate:(id)arg2 completionBlock:(/*^block*/id)arg3 errorBlock:(/*^block*/id)arg4 ;
-(void)setContinuation:(id)arg1 continuationDate:(id)arg2 ;
-(char)isTryingAgainLater;
