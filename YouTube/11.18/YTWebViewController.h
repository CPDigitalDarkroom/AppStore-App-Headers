...
#import <YouTube/GIPWebViewControllerDelegate.h>
#import <YouTube/YTTopController.h>

@protocol YTResponder;
@class GIMMe, NSString;

@interface YTWebViewController : GIPWebViewController <GIPWebViewControllerDelegate, YTTopController> {

	char _themeColorEnabled;
...
-(void)setThemeColorEnabled:(char)arg1 ;
-(id)model;
