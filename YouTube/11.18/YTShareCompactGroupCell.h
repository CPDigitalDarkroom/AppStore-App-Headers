...
@class YTISharingGroupRenderer, YTShareContactView, NSString;

@interface YTShareCompactGroupCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTThumbnailMapping> {
