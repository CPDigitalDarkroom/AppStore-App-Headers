...
@interface YTICommentActionResponse : PBGeneratedMessage

@property (assign,nonatomic) char hasResponseContext; 
@property (nonatomic,retain) YTIResponseContext * responseContext; 
@property (assign,nonatomic) char hasActionResultsArray; 
@property (nonatomic,retain) PBMutableArray * actionResultsArray; 
