...
@interface YTISetNotificationRegistrationResponse : PBGeneratedMessage

@property (assign,nonatomic) char hasResponseContext; 
@property (nonatomic,retain) YTIResponseContext * responseContext; 
@property (assign,nonatomic) char hasNotificationRegistrationId; 
@property (nonatomic,retain) NSString * notificationRegistrationId; 
