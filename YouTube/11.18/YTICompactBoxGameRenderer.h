...
@class YTIAssociatedGameSupportedRenderers, YTIGamingSubscribeButtonSupportedRenderers, NSData, PBMutableArray;

@interface YTICompactBoxGameRenderer : PBGeneratedMessage
