...
#import <YouTube/YTSlideForActionsViewDelegate.h>
#import <YouTube/YTCellActionConfirmationCellProtocol.h>

@protocol YTResponder;
@class YTIOverflowContactCompositeRenderer, YTSlideForActionsView, YTShareContactView, QTMButton, NSString;

@interface YTOverflowContactCompositeCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTThumbnailMapping, YTSlideForActionsViewDelegate, YTCellActionConfirmationCellProtocol> {
