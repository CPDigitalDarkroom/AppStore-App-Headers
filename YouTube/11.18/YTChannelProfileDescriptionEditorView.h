...
@class YTIChannelProfileDescriptionEditorRenderer, GOOMultilineTextField, NSString;

@interface YTChannelProfileDescriptionEditorView : UIScrollView <GOOMultilineTextFieldDelegate> {
