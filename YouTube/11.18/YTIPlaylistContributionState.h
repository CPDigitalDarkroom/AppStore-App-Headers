...
@interface YTIPlaylistContributionState : PBGeneratedMessage
...
@property (assign,nonatomic) char hasSetStateEndpoint; 
@property (nonatomic,retain) YTIServiceEndpoint * setStateEndpoint; 
+(id)descriptor;
@end
