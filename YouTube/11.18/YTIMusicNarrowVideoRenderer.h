...
@class YTIMusicNarrowVideoThumbnailSupportedRenderers, YTIFormattedString, YTINavigationEndpoint, PBMutableArray, NSData, YTIIcon, YTIMenuSupportedRenderers, YTIIosClientOfflineData;

@interface YTIMusicNarrowVideoRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnailRenderer; 
@property (nonatomic,retain) YTIMusicNarrowVideoThumbnailSupportedRenderers * thumbnailRenderer; 
