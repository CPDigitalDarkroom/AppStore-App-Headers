...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, PBMutableArray, NSData, YTIStandaloneBadgeSupportedRenderers;

@interface YTIGridMovieRenderer : PBGeneratedMessage
