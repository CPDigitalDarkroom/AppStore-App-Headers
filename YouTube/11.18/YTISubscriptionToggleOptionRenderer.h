...
@class NSData, YTIFormattedString, YTIButtonSupportedRenderers;

@interface YTISubscriptionToggleOptionRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasInitialValue; 
@property (assign,nonatomic) long long initialValue; 
+(id)descriptor;
@end
