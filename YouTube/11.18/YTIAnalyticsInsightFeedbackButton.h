...
@class YTIFormattedString, YTIServiceEndpoint, NSData;

@interface YTIAnalyticsInsightFeedbackButton : PBGeneratedMessage
...
@property (assign,nonatomic) char hasShowFollowup; 
@property (assign,nonatomic) char showFollowup; 
