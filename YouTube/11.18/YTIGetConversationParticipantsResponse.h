...
@class NSString, YTIResponseContext, YTISectionListRenderer;

@interface YTIGetConversationParticipantsResponse : PBGeneratedMessage <YTInnerTubeSectionRenderers>
...
@property (nonatomic,retain) YTISectionListRenderer * contents; 
