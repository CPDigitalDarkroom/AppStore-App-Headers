...
@property (nonatomic,readonly) YTIVideoQualityPromoRenderer * promoRenderer;              //@synthesize promoRenderer=_promoRenderer - In the implementation block
+(id)eventWithPromoRenderer:(id)arg1 firstResponder:(id)arg2 ;
-(YTIVideoQualityPromoRenderer *)promoRenderer;
