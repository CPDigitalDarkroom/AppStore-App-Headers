...
@class NSString, YTIFormattedString, PBMutableArray, YTINavigationEndpoint, YTILikeButtonSupportedRenderers, NSData, YTIMenuSupportedRenderers, YTIPlaylistThumbnailSupportedRenderers;

@interface YTIPlaylistRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasVideoCount; 
@property (assign,nonatomic) long long videoCount; 
@property (assign,nonatomic) char hasNavigationEndpoint; 
@property (nonatomic,retain) YTINavigationEndpoint * navigationEndpoint; 
@property (assign,nonatomic) char hasViewPlaylistText; 
@property (nonatomic,retain) YTIFormattedString * viewPlaylistText; 
