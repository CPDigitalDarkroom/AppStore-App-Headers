...
@class NSString, YTIFormattedString, YTIThumbnailDetails, YTINavigationEndpoint, NSData, PBMutableArray, YTIMenuSupportedRenderers;

@interface YTIRadioRenderer : PBGeneratedMessage
