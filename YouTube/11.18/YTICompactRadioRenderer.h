...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, NSData, PBMutableArray, YTILikeButtonSupportedRenderers, YTIMenuSupportedRenderers;

@interface YTICompactRadioRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasOverlayImage; 
@property (nonatomic,retain) YTIThumbnailDetails * overlayImage; 
