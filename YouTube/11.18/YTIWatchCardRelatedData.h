...
@interface YTIWatchCardRelatedData : PBGeneratedMessage

@property (assign,nonatomic) char hasTitle; 
@property (nonatomic,retain) YTIFormattedString * title; 
@property (assign,nonatomic) char hasEntitiesArray; 
@property (nonatomic,retain) PBMutableArray * entitiesArray; 
