...
@class NSData, YTIThumbnailDetails, YTINavigationEndpoint, YTIFormattedString;

@interface YTIEntitySuggestionRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIFormattedString * type; 
+(id)descriptor;
@end
