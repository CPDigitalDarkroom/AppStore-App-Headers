...
@class NSString, YTISortFilterSubMenuSupportedContinuations, YTIIcon;

@interface YTISortFilterSubMenuItem : PBGeneratedMessage
...
@property (nonatomic,retain) YTISortFilterSubMenuSupportedContinuations * continuation; 
