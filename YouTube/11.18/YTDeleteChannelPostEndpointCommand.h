...
@class YTChannelEditService, YTActionRouter, NSString;

@interface YTDeleteChannelPostEndpointCommand : NSObject <YTServiceEndpointCommand> {
...
-(id)initWithChannelEditService:(id)arg1 actionRouter:(id)arg2 ;
