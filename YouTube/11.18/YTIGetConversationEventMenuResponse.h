...
@class YTIResponseContext, YTIMenuSupportedRenderers, NSString;

@interface YTIGetConversationEventMenuResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIMenuSupportedRenderers * contents; 
