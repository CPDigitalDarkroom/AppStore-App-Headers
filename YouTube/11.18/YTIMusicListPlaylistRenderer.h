...
@class YTIMusicListPlaylistThumbnailSupportedRenderers, PBMutableArray, YTIFormattedString, YTINavigationEndpoint, YTIMenuSupportedRenderers, NSData;

@interface YTIMusicListPlaylistRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnailRenderer; 
@property (nonatomic,retain) YTIMusicListPlaylistThumbnailSupportedRenderers * thumbnailRenderer; 
