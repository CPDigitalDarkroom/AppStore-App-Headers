...
@class YTIMusicNarrowArtistRadioThumbnailSupportedRenderers, YTIFormattedString, YTINavigationEndpoint, YTIMenuSupportedRenderers, NSData;

@interface YTIMusicNarrowArtistRadioRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnailRenderer; 
@property (nonatomic,retain) YTIMusicNarrowArtistRadioThumbnailSupportedRenderers * thumbnailRenderer; 
