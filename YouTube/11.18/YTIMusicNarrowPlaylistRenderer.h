...
@class YTIMusicNarrowPlaylistThumbnailSupportedRenderers, YTIFormattedString, YTINavigationEndpoint, NSData, PBMutableArray, YTIMenuSupportedRenderers;

@interface YTIMusicNarrowPlaylistRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnailRenderer; 
@property (nonatomic,retain) YTIMusicNarrowPlaylistThumbnailSupportedRenderers * thumbnailRenderer; 
