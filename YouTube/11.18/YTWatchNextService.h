...
#import <YouTube/YTInnerTubeUIServiceWithTimeoutInterval.h>
...
-(void)makeRequest:(id)arg1 refresh:(char)arg2 timeoutInterval:(double)arg3 responseBlock:(/*^block*/id)arg4 errorBlock:(/*^block*/id)arg5 ;
-(void)clearCaches;
-(Class)responseClass;
-(Class)requestClass;
@end
