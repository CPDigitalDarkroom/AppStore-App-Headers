...
@class NSString, YTIFormattedString, PBMutableArray, NSData, YTIButtonSupportedRenderers;

@interface YTIConnectionsOverflowMenuRenderer : PBGeneratedMessage <YTInnerTubeSectionRenderers>
