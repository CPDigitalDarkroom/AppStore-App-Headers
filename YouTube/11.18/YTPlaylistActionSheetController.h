...
@class YTSharingActionSheetController, GIMMe, NSString;

@interface YTPlaylistActionSheetController : NSObject <YTResponder> {
...
-(void)showShareActionsWithPlaylistID:(id)arg1 URL:(id)arg2 title:(id)arg3 inRotatedView:(id)arg4 ;
@end
