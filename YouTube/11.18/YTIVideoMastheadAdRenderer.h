...
@interface YTIVideoMastheadAdRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasDebugHtml; 
@property (nonatomic,retain) NSString * debugHtml; 
@property (assign,nonatomic) char hasShowAdText; 
@property (nonatomic,retain) YTIFormattedString * showAdText; 
+(id)descriptor;
@end
