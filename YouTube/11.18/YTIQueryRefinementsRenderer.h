...
@interface YTIQueryRefinementsRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasTitle; 
@property (nonatomic,retain) YTIFormattedString * title; 
@property (assign,nonatomic) char hasQueriesArray; 
@property (nonatomic,retain) PBMutableArray * queriesArray; 
