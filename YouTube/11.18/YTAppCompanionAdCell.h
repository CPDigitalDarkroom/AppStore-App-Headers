...
@class YTIAppPromoCompanionAdRenderer, YTBadge, YTFormattedStringLabel, YTRatingView, YTImageView, UIButton, YTButton, NSString;

@interface YTAppCompanionAdCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTThumbnailMapping> {
