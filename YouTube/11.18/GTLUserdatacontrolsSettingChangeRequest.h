...
@interface GTLUserdatacontrolsSettingChangeRequest : GTLObject

@property (assign,nonatomic) int targetValueAsEnum; 
@property (nonatomic,retain) NSNumber * settingId; 
@property (nonatomic,copy) NSString * targetValue; 
-(int)targetValueAsEnum;
-(void)setTargetValueAsEnum:(int)arg1 ;
@end
