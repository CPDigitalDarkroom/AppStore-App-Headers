...
@class YTIMusicWideAlbumThumbnailSupportedRenderers, YTIFormattedString, YTINavigationEndpoint, YTIMenuSupportedRenderers, NSData;

@interface YTIMusicWideAlbumRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnailRenderer; 
@property (nonatomic,retain) YTIMusicWideAlbumThumbnailSupportedRenderers * thumbnailRenderer; 
