...
@class YTIResponseContext, NSString, PBMutableArray, YTIItemSectionContactUpdateSupportedRenderers;

@interface YTIEditConnectionStateResponse : PBGeneratedMessage
...
@property (assign,nonatomic) char hasReplacementRenderer; 
@property (nonatomic,retain) YTIItemSectionContactUpdateSupportedRenderers * replacementRenderer; 
+(id)descriptor;
@end
