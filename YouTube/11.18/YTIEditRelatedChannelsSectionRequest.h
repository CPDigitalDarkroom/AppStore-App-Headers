...
@interface YTIEditRelatedChannelsSectionRequest : PBGeneratedMessage

@property (assign,nonatomic) char hasContext; 
@property (nonatomic,retain) YTIInnerTubeContext * context; 
@property (assign,nonatomic) char hasMakeEnabled; 
@property (assign,nonatomic) char makeEnabled; 
+(id)descriptor;
@end
