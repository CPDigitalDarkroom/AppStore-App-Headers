...
+(char)isBackgroundDownloadFetcherForSessionIndentifier:(id)arg1 ;
...
-(void)retryFetch;
-(void)beginContentFetchWithCompletionHandler:(/*^block*/id)arg1 ;
...
-(void)setIsBackgroundDownloadFetcher:(char)arg1 ;
