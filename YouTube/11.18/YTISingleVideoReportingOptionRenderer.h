...
@class YTIFormattedString, PBMutableArray, YTIServiceEndpoint, NSData, YTIAccessibilityData;

@interface YTISingleVideoReportingOptionRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasTitle; 
@property (nonatomic,retain) YTIFormattedString * title; 
@property (assign,nonatomic) char hasTextsArray; 
@property (nonatomic,retain) PBMutableArray * textsArray; 
@property (assign,nonatomic) char hasReportLabel; 
@property (nonatomic,retain) YTIFormattedString * reportLabel; 
