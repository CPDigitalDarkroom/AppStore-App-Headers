...
@class NSString, PBMutableArray, YTIFormattedString, YTINavigationEndpoint, NSData;

@interface YTIChannelListRenderer : PBGeneratedMessage <YTInnerTubeSectionRenderer>
...
@property (assign,nonatomic) char hasAddText; 
@property (nonatomic,retain) YTIFormattedString * addText; 
@property (assign,nonatomic) char hasAddEndpoint; 
@property (nonatomic,retain) YTINavigationEndpoint * addEndpoint; 
