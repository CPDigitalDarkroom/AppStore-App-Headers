...
@class YTIMusicPassSmallFeatureInfoRenderer, YTMusicPassSmallFeatureInfoView, NSString;

@interface YTMusicPassSmallFeatureInfoCell : YTCollectionViewCell <YTFormattedStringLabelDelegate, YTFeedViewCellProtocol, YTThumbnailMapping> {
