...
@class YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, YTIPlayerResponse, NSString, NSData, YTILikeButtonSupportedRenderers, YTIMenuSupportedRenderers, YTIShareButtonSupportedRenderers;

@interface YTIAutoplayVideoRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIPlayerResponse * playerResponse; 
