...
@class YTIResponseContext, YTINavigationEndpoint, PBMutableArray, NSString;

@interface YTIEditConversationResponse : PBGeneratedMessage
...
@property (assign,nonatomic) char hasConversationIdToRemove; 
@property (nonatomic,retain) NSString * conversationIdToRemove; 
@property (assign,nonatomic) char hasConversationIdToRefresh; 
@property (nonatomic,retain) NSString * conversationIdToRefresh; 
+(id)descriptor;
@end
