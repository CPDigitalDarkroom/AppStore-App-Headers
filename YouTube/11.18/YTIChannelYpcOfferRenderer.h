...
@interface YTIChannelYpcOfferRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasPrices; 
@property (nonatomic,retain) YTIFormattedString * prices; 
@property (assign,nonatomic) char hasAdditionalInfo; 
@property (nonatomic,retain) YTIFormattedString * additionalInfo; 
