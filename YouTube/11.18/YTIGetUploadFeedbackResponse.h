...
@interface YTIGetUploadFeedbackResponse : PBGeneratedMessage
...
@property (assign,nonatomic) char hasContinuationContentsArray; 
@property (nonatomic,retain) PBMutableArray * continuationContentsArray; 
