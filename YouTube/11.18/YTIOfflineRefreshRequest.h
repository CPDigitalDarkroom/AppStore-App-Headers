...
@interface YTIOfflineRefreshRequest : PBGeneratedMessage

@property (assign,nonatomic) char hasContext; 
@property (nonatomic,retain) YTIInnerTubeContext * context; 
@property (assign,nonatomic) char hasVideoSetsArray; 
@property (nonatomic,retain) PBMutableArray * videoSetsArray; 
