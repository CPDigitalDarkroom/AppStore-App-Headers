...
@property (assign,nonatomic) float distanceNormalizationFactor;              //@synthesize distanceNormalizationFactor=_distanceNormalizationFactor - In the implementation block
-(void)setDistanceNormalizationFactor:(float)arg1 ;
