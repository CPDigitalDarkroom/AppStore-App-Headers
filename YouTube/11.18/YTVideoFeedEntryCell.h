...
@class YTIFeedEntryRenderer, YTIVideoRenderer, YTPostFeedEntryView, YTVideoView, NSString;

@interface YTVideoFeedEntryCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTCellActionProtocol, YTCellLinkProtocol, YTResponder, YTThumbnailMapping> {
