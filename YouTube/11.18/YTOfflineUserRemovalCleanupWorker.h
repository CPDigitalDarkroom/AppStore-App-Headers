...
@class YTOfflineCoordinator, YTUserDefaults, NSTimer, NSDate, NSString;
...
-(id)initWithOfflineCoordinator:(id)arg1 identityProvider:(id)arg2 userDefaults:(id)arg3 ;
...
-(void)getAllAvailableIdentitiesAndDeleteUnusedForUserIDs:(id)arg1 completionBlock:(/*^block*/id)arg2 errorBlock:(/*^block*/id)arg3 ;
