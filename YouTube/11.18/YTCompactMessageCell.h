...
@class YTICompactMessageRenderer, UIView, UIImageView, YTImageView, YTLabel, NSString;

@interface YTCompactMessageCell : YTCollectionViewCell <YTFeedViewCellProtocol, YTThumbnailMapping> {
...
@property (nonatomic,retain) YTICompactMessageRenderer * entry;                     //@synthesize entry=_entry - In the implementation block
...
-(void)setEntry:(YTICompactMessageRenderer *)arg1 ;
-(id)initWithFrame:(CGRect)arg1 ;
-(void)layoutSubviews;
-(YTICompactMessageRenderer *)entry;
@end
