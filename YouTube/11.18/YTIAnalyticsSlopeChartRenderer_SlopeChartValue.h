...
@interface YTIAnalyticsSlopeChartRenderer_SlopeChartValue : PBGeneratedMessage

@property (assign,nonatomic) char hasLabel; 
@property (nonatomic,retain) NSString * label; 
@property (assign,nonatomic) char hasStartValue; 
@property (assign,nonatomic) double startValue; 
@property (assign,nonatomic) char hasEndValue; 
