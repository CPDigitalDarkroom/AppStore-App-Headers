...
@class YTINavigationEndpoint, NSString, YTIThumbnailDetails, PBMutableArray, YTIMenuItemTitleSupportedRenderers;

@interface YTIMenuItem : PBGeneratedMessage
...
@property (nonatomic,retain) YTIMenuItemTitleSupportedRenderers * titleRenderer; 
+(id)descriptor;
@end
