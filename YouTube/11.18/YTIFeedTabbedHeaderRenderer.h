...
@interface YTIFeedTabbedHeaderRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasTitle; 
@property (nonatomic,retain) YTIFormattedString * title; 
@property (assign,nonatomic) char hasFilterTabsArray; 
@property (nonatomic,retain) PBMutableArray * filterTabsArray; 
@property (assign,nonatomic) char hasManagementTabsArray; 
@property (nonatomic,retain) PBMutableArray * managementTabsArray; 
