...
@interface YTIAnalyticsEntityReferenceRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasText; 
@property (nonatomic,retain) YTIFormattedString * text; 
@property (assign,nonatomic) char hasEntityEndpoint; 
@property (nonatomic,retain) YTINavigationEndpoint * entityEndpoint; 
