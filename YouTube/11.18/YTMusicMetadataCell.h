...
@class YTFormattedStringLabel, YTIMusicMetadataRenderer, NSString;

@interface YTMusicMetadataCell : YTCollectionViewCell <YTFeedViewCellProtocol> {

	YTFormattedStringLabel* _moreFromLabel;
	YTIMusicMetadataRenderer* _entry;
