...
@class YTIResponseContext, NSString, YTICreateDraftVideoResponseSupportedRenderers;

@interface YTICreateDraftVideoResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTICreateDraftVideoResponseSupportedRenderers * contents; 
+(id)descriptor;
@end
