...
@interface GIDASStaticAccountManagerExtension : NSObject <SSOAccountManagerExtension> {
...
-(id)initWithService:(id)arg1 ULRManager:(id)arg2 shouldUseUDC:(char)arg3 ;
...
-(id)viewControllerForRowIndex:(int)arg1 identity:(id)arg2 ;
-(id)menuTitles;
@end
