...
@class YTIMusicWidePlaylistThumbnailSupportedRenderers, YTIFormattedString, YTINavigationEndpoint, NSData;

@interface YTIMusicWidePlaylistRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnailRenderer; 
@property (nonatomic,retain) YTIMusicWidePlaylistThumbnailSupportedRenderers * thumbnailRenderer; 
