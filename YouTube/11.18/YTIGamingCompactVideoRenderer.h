...
@class NSString, YTIThumbnailDetails, YTIFormattedString, YTINavigationEndpoint, PBMutableArray, YTIMenuSupportedRenderers, YTIAssociatedGameSupportedRenderers, NSData, YTIGamingCompactVideoRenderer_GamingCompactVideoOfflineabilitySupportedRenderers;

@interface YTIGamingCompactVideoRenderer : PBGeneratedMessage
...
@property (nonatomic,retain) YTIGamingCompactVideoRenderer_GamingCompactVideoOfflineabilitySupportedRenderers * offlineability; 
