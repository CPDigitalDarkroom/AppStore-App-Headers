...
@class YTIHintButtonStyle, YTIIcon, YTIFormattedString, YTIServiceEndpoint, YTINavigationEndpoint, YTIAccessibilitySupportedDatas, NSData;

@interface YTIHintButtonRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasStyle; 
@property (nonatomic,retain) YTIHintButtonStyle * style; 
