...
@class YTSettingsService, YTOfflineSettingsService, NSString;
...
-(id)initWithOfflineModeProvider:(id)arg1 innerTubeSettingsService:(id)arg2 offlineSettingsService:(id)arg3 ;
-(void)clearCaches;
-(Class)responseClass;
-(Class)requestClass;
@end
