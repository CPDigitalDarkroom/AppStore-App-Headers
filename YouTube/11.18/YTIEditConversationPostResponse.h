...
@class YTIResponseContext, YTIConversationItemSupportedRenderers, NSString, PBMutableArray;

@interface YTIEditConversationPostResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIConversationItemSupportedRenderers * contents; 
