...
@class YTIResponseContext, YTIUpdateCommentReplyResponseSupportedRenderers, NSString;

@interface YTIUpdateCommentReplyResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIUpdateCommentReplyResponseSupportedRenderers * contents; 
