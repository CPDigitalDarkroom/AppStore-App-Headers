...
@class NSString, YTIFormattedString, PBMutableArray, NSData, YTIContactSelectMessageSupportedRenderers;

@interface YTIInviteMorePanelContactsSectionRenderer : PBGeneratedMessage <YTInnerTubeSectionRenderer>
