...
@class YTIResponseContext, PBMutableArray, YTIVMVideoListSupportedContinuations, NSString;

@interface YTIVideoListResponse : PBGeneratedMessage
...
@property (nonatomic,retain) YTIVMVideoListSupportedContinuations * continuation; 
