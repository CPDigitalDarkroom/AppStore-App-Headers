...
@interface YTIUnpluggedSearchOneboxRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasThumbnail; 
@property (nonatomic,retain) YTIThumbnailDetails * thumbnail; 
@property (assign,nonatomic) char hasThumbnailType; 
@property (assign,nonatomic) int thumbnailType; 
@property (assign,nonatomic) char hasOneboxHeader; 
@property (nonatomic,retain) YTIFormattedString * oneboxHeader; 
