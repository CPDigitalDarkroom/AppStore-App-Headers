...
@class YTIConversationSwitcherSectionRenderer, YTFormattedStringLabel, UIView, NSString;

@interface YTConversationSwitcherShowMoreCell : UICollectionViewCell <YTFeedViewCellProtocol> {

	YTIConversationSwitcherSectionRenderer* _entry;
	YTFormattedStringLabel* _showMoreLabel;
