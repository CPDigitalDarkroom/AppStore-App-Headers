...
@class YTIFormattedString, YTIThumbnailDetails, NSData, NSString;

@interface YTIEpgAiringRenderer : PBGeneratedMessage

@property (assign,nonatomic) char hasBeginTimeMs; 
@property (assign,nonatomic) long long beginTimeMs; 
...
@property (assign,nonatomic) char hasSnippet; 
@property (nonatomic,retain) YTIFormattedString * snippet; 
