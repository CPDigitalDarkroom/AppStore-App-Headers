...
@interface YTIGetSharedConversationRequest : PBGeneratedMessage <YTConversationRequestProtocol>
...
@property (assign,nonatomic) char hasMarkConversationAsRead; 
@property (assign,nonatomic) char markConversationAsRead; 
+(id)descriptor;
@end
