...
@class NSString, YTIFormattedString, YTIThumbnailDetails, YTINavigationEndpoint, NSData, PBMutableArray, YTIIcon;

@interface YTIMiniRadioRenderer : PBGeneratedMessage
...
@property (assign,nonatomic) char hasActionIcon; 
@property (nonatomic,retain) YTIIcon * actionIcon; 
