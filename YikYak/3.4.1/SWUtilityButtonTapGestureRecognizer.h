...
@interface SWUtilityButtonTapGestureRecognizer : UITapGestureRecognizer {
	...
	unsigned _buttonIndex;

}

@property (assign,nonatomic) unsigned buttonIndex;              //@synthesize buttonIndex=_buttonIndex - In the implementation block
-(unsigned)buttonIndex;
-(void)setButtonIndex:(unsigned)arg1 ;
@end
