...
@interface YYPlaceholderView : YYView {

	char _shouldHideImage;
...
@property (assign,nonatomic) char shouldHideImage;                           //@synthesize shouldHideImage=_shouldHideImage - In the implementation block
@property (assign,nonatomic) int placeholderType;                            //@synthesize placeholderType=_placeholderType - In the implementation block
...
-(void)setPlaceholderType:(int)arg1 ;
-(FBShimmeringView *)shimmeringView;
-(char)shouldHideImage;
-(void)setShouldHideImage:(char)arg1 ;
