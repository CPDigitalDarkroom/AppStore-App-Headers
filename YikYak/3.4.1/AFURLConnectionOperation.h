...
@property (assign,setter=af_setUploadProgressAnimated:,nonatomic) char af_uploadProgressAnimated; 
@property (nonatomic,copy) id downloadProgress; 
@property (assign,setter=af_setDownloadProgressAnimated:,nonatomic) char af_downloadProgressAnimated; 
