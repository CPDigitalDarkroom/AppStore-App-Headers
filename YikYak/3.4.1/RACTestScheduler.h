...
@interface RACTestScheduler : RACScheduler {
	...
	unsigned _numberOfDirectlyScheduledBlocks;
...
@property (assign,nonatomic) unsigned numberOfDirectlyScheduledBlocks;              //@synthesize numberOfDirectlyScheduledBlocks=_numberOfDirectlyScheduledBlocks - In the implementation block
...
-(unsigned)numberOfDirectlyScheduledBlocks;
-(void)setNumberOfDirectlyScheduledBlocks:(unsigned)arg1 ;
-(void)dealloc;
-(id)init;
-(void)step:(unsigned)arg1 ;
-(void)step;
@end
