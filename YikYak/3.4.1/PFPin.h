...
+(id)pinAllAsync:(id)arg1 withName:(id)arg2 includeChildren:(char)arg3 ;
+(id)unpinObjectsWithNameAsync:(id)arg1 ;
+(id)unpinAllAsync:(id)arg1 withName:(id)arg2 ;
+(id)pinFromNameAsync:(id)arg1 ;
+(id)pinAllAsync:(id)arg1 withName:(id)arg2 ;
