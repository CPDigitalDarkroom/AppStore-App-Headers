...
@class NSError, NSMutableArray, NSEnumerator, PFHTTPMultipartRequestBodyPart, NSOutputStream, NSMutableData, NSString;
...
@property (assign) unsigned streamStatus;                                                       //@synthesize streamStatus=_streamStatus - In the implementation block
@property (copy) NSError * streamError;                                                         //@synthesize streamError=_streamError - In the implementation block
...
@property (nonatomic,retain) PFHTTPMultipartRequestBodyPart * currentHTTPBodyPart;              //@synthesize currentHTTPBodyPart=_currentHTTPBodyPart - In the implementation block
...
-(PFHTTPMultipartRequestBodyPart *)currentHTTPBodyPart;
-(NSEnumerator *)HTTPBodyPartEnumerator;
-(void)setCurrentHTTPBodyPart:(PFHTTPMultipartRequestBodyPart *)arg1 ;
