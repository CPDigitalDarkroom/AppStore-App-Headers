...
@interface Yik_Yak.YYLeftHandVotingRemovedPromptHelper : NSObject
+(void)setVotingContainerPosition:(long)arg1 ;
+(void)promptIfNecessary;
+(id)kVotingContainerPositionDefaultsKey;
+(long)getVotingContainerPosition;
-(id)init;
@end
