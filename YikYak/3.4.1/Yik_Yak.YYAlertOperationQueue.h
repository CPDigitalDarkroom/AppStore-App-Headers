...
@interface Yik_Yak.YYAlertOperationQueue : NSOperationQueue
+(void)showRetryAlertWithTitle:(id)arg1 message:(id)arg2 retryBlock:(/*^block*/id)arg3 cancelBlock:(/*^block*/id)arg4 ;
+(id)sharedQueue;
-(id)init;
@end
