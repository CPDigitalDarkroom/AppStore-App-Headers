...
+(id)runCommandAsync:(id)arg1 inOperation:(id)arg2 cachePolicy:(unsigned char)arg3 maxCacheAge:(double)arg4 ;
+(id)getCachedResultForCommandAsync:(id)arg1 inOperation:(id)arg2 maxCacheAge:(double)arg3 ;
+(id)runCommandAsync:(id)arg1 cachePolicy:(unsigned char)arg2 maxCacheAge:(double)arg3 ;
+(void)initialize;
@end
