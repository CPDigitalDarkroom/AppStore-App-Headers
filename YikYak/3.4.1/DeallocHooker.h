...
@interface DeallocHooker : NSObject {
	...
	/*^block*/id _willDealloc;

}

@property (nonatomic,copy) id willDealloc;              //@synthesize willDealloc=_willDealloc - In the implementation block
-(id)willDealloc;
-(void)setWillDealloc:(id)arg1 ;
-(void)dealloc;
@end
