...
@class NSMutableArray, NSArray, NSAttributedString, NSString, PTHTweetbotBoundingBox, NSURL, NSDate, PTHTweetbotPlace, PTHTweetbotUser, PTHTweetbotCursor;

@interface PTHTweetbotStatus : PTHTweetbotObject <UIActivityItemSource> {

	NSMutableArray* _refreshBlocks;
	char _mentionsCurrentUser;
	char _quotesCurrentUser;
	char _favorited;
	char _retweeted;
	char _missing;
	char _refreshing;
	...
	unsigned _replyCount;
	unsigned _quoteCount;
	NSString* _source;
...
@property (nonatomic,readonly) char mentionsCurrentUser;                                      //@synthesize mentionsCurrentUser=_mentionsCurrentUser - In the implementation block
@property (nonatomic,readonly) char quotesCurrentUser;                                        //@synthesize quotesCurrentUser=_quotesCurrentUser - In the implementation block
...
@property (assign,getter=isRetweeted,nonatomic) char retweeted;                               //@synthesize retweeted=_retweeted - In the implementation block
@property (assign,nonatomic) unsigned retweetCount;                                           //@synthesize retweetCount=_retweetCount - In the implementation block
@property (assign,nonatomic) unsigned replyCount;                                             //@synthesize replyCount=_replyCount - In the implementation block
@property (assign,nonatomic) unsigned quoteCount;                                             //@synthesize quoteCount=_quoteCount - In the implementation block
...
@property (nonatomic,readonly) char canRetweet; 
@property (nonatomic,readonly) char canUnretweet; 
@property (nonatomic,readonly) char isReply; 
@property (nonatomic,readonly) char isReplyToCurrentUser; 
...
-(char)isReplyToCurrentUser;
-(char)_updateFromDictionary:(id)arg1 ;
...
-(void)setReplyCount:(unsigned)arg1 ;
-(void)setQuoteCount:(unsigned)arg1 ;
-(char)quotesCurrentUser;
