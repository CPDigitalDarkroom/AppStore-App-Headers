...
+(id)dictionaryWithValue:(int)arg1 forKey:(char)arg2 ;
+(id)dictionaryWithValues:(const int*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const int*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
