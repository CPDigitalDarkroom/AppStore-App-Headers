...
@property (assign,nonatomic) double call_self_asn;                                             //@synthesize call_self_asn=_call_self_asn - In the implementation block
@property (assign,nonatomic) double call_peer_asn;                                             //@synthesize call_peer_asn=_call_peer_asn - In the implementation block
...
-(void)setCall_self_asn:(double)arg1 ;
-(double)call_peer_asn;
-(void)setCall_peer_asn:(double)arg1 ;
