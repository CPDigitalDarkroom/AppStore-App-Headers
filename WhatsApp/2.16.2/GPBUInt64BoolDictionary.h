...
+(id)dictionaryWithValue:(char)arg1 forKey:(unsigned long long)arg2 ;
+(id)dictionaryWithValues:(const char*)arg1 forKeys:(const unsigned long long*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const char*)arg1 forKeys:(const unsigned long long*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(unsigned long long)arg1 value:(char*)arg2 ;
-(void)setValue:(char)arg1 forKey:(unsigned long long)arg2 ;
-(void)dealloc;
-(unsigned)count;
-(id)init;
