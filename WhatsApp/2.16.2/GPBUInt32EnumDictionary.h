...
+(id)dictionaryWithValidationFunction:(/*function pointer*/void*)arg1 rawValues:(const int*)arg2 forKeys:(const unsigned*)arg3 count:(unsigned)arg4 ;
...
-(char)valueForKey:(unsigned)arg1 value:(int*)arg2 ;
-(id)initWithValidationFunction:(/*function pointer*/void*)arg1 rawValues:(const int*)arg2 forKeys:(const unsigned*)arg3 count:(unsigned)arg4 ;
...
-(char)valueForKey:(unsigned)arg1 rawValue:(int*)arg2 ;
