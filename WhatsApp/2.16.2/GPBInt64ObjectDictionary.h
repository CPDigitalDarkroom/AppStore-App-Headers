...
+(id)dictionaryWithObjects:(const id*)arg1 forKeys:(const long long*)arg2 count:(unsigned)arg3 ;
...
-(id)initWithObjects:(const id*)arg1 forKeys:(const long long*)arg2 count:(unsigned)arg3 ;
