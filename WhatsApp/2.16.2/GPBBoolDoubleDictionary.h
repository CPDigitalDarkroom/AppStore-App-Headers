...
+(id)dictionaryWithValue:(double)arg1 forKey:(char)arg2 ;
+(id)dictionaryWithValues:(const double*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const double*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(char)arg1 value:(double*)arg2 ;
-(void)setValue:(double)arg1 forKey:(char)arg2 ;
-(unsigned)count;
-(id)init;
