...
+(id)dictionaryWithValues:(const unsigned long long*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned long long*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(int)arg1 value:(unsigned long long*)arg2 ;
