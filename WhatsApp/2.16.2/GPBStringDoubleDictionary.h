...
+(id)dictionaryWithValues:(const double*)arg1 forKeys:(id*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const double*)arg1 forKeys:(id*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(id)arg1 value:(double*)arg2 ;
