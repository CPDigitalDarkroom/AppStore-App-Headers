...
+(id)dictionaryWithValue:(char)arg1 forKey:(long long)arg2 ;
+(id)dictionaryWithValues:(const char*)arg1 forKeys:(const long long*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const char*)arg1 forKeys:(const long long*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(long long)arg1 value:(char*)arg2 ;
-(void)setValue:(char)arg1 forKey:(long long)arg2 ;
-(void)dealloc;
-(unsigned)count;
-(id)init;
