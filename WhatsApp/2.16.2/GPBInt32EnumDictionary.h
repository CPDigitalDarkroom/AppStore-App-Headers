...
+(id)dictionaryWithValidationFunction:(/*function pointer*/void*)arg1 rawValues:(const int*)arg2 forKeys:(const int*)arg3 count:(unsigned)arg4 ;
...
-(char)valueForKey:(int)arg1 value:(int*)arg2 ;
-(id)initWithValidationFunction:(/*function pointer*/void*)arg1 rawValues:(const int*)arg2 forKeys:(const int*)arg3 count:(unsigned)arg4 ;
...
-(char)valueForKey:(int)arg1 rawValue:(int*)arg2 ;
