...
+(id)dictionaryWithValue:(long long)arg1 forKey:(char)arg2 ;
+(id)dictionaryWithValues:(const long long*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const long long*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(char)arg1 value:(long long*)arg2 ;
-(void)setValue:(long long)arg1 forKey:(char)arg2 ;
-(unsigned)count;
-(id)init;
