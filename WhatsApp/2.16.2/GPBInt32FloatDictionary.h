...
+(id)dictionaryWithValues:(const float*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const float*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(int)arg1 value:(float*)arg2 ;
