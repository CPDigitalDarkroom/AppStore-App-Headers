...
@interface WAWebClientSession : NSObject {
	...
	char _preemptiveChatResponseSent;
	char _preemptiveContactsResponseSent;
	NSString* _browserID;
...
@property (assign,nonatomic) char preemptiveChatResponseSent;                  //@synthesize preemptiveChatResponseSent=_preemptiveChatResponseSent - In the implementation block
@property (assign,nonatomic) char preemptiveContactsResponseSent;              //@synthesize preemptiveContactsResponseSent=_preemptiveContactsResponseSent - In the implementation block
...
-(char)preemptiveChatResponseSent;
-(void)setPreemptiveChatResponseSent:(char)arg1 ;
-(char)preemptiveContactsResponseSent;
-(void)setPreemptiveContactsResponseSent:(char)arg1 ;
