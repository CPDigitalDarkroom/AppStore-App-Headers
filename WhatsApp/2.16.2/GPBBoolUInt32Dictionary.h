...
+(id)dictionaryWithValue:(unsigned)arg1 forKey:(char)arg2 ;
+(id)dictionaryWithValues:(const unsigned*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(char)arg1 value:(unsigned*)arg2 ;
-(void)setValue:(unsigned)arg1 forKey:(char)arg2 ;
-(unsigned)count;
-(id)init;
