...
@property (assign,nonatomic) char useDeviceName;                                             //@synthesize useDeviceName=_useDeviceName - In the implementation block
...
-(void)setUseDeviceName:(char)arg1 ;
...
-(char)useDeviceName;
-(void)showProfilePhotoActivity:(char)arg1 ;
...
-(void)importUsernameFromFBAccount:(id)arg1 accountRenewed:(char)arg2 ;
