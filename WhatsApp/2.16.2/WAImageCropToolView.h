...
@interface WAImageCropToolView : UIView {
	...
	char _allowsWidthIncrease;
	char _allowsHeightIncrease;
...
@property (assign,nonatomic) char allowsWidthIncrease;                                     //@synthesize allowsWidthIncrease=_allowsWidthIncrease - In the implementation block
@property (assign,nonatomic) char allowsHeightIncrease;                                    //@synthesize allowsHeightIncrease=_allowsHeightIncrease - In the implementation block
-(void)didEndDragging;
-(void)setInitialCropRect:(CGRect)arg1 ;
-(void)setAllowsWidthIncrease:(char)arg1 ;
-(void)setAllowsHeightIncrease:(char)arg1 ;
-(void)constrainAspectRatioForVideo;
-(void)constrainAspectRatioForImage;
-(void)setRotationGridAlpha:(float)arg1 ;
-(void)setCropGridAlpha:(float)arg1 ;
-(char)allowsWidthIncrease;
-(CGRect)initialCropRect;
-(char)allowsHeightIncrease;
-(void)reportCropRectChangeIfNeeded;
-(float)rotationGridAlpha;
-(float)cropGridAlpha;
-(char)pointIsInsideCroppedArea:(CGPoint)arg1 ;
