...
+(id)dictionaryWithValues:(const float*)arg1 forKeys:(const long long*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const float*)arg1 forKeys:(const long long*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(long long)arg1 value:(float*)arg2 ;
