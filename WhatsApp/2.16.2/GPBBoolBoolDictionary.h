...
+(id)dictionaryWithValue:(char)arg1 forKey:(char)arg2 ;
+(id)dictionaryWithValues:(const char*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const char*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(char)arg1 value:(char*)arg2 ;
-(void)setValue:(char)arg1 forKey:(char)arg2 ;
-(unsigned)count;
-(id)init;
