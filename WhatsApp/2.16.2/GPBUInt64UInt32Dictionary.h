...
+(id)dictionaryWithValues:(const unsigned*)arg1 forKeys:(const unsigned long long*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned*)arg1 forKeys:(const unsigned long long*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(unsigned long long)arg1 value:(unsigned*)arg2 ;
