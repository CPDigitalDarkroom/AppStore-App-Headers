...
+(id)dictionaryWithValue:(char)arg1 forKey:(id)arg2 ;
+(id)dictionaryWithValues:(const char*)arg1 forKeys:(id*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const char*)arg1 forKeys:(id*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(id)arg1 value:(char*)arg2 ;
-(void)setValue:(char)arg1 forKey:(id)arg2 ;
-(void)dealloc;
-(unsigned)count;
-(id)init;
