...
+(id)dictionaryWithValidationFunction:(/*function pointer*/void*)arg1 rawValue:(int)arg2 forKey:(char)arg3 ;
+(id)dictionaryWithValidationFunction:(/*function pointer*/void*)arg1 rawValues:(const int*)arg2 forKeys:(const char*)arg3 count:(unsigned)arg4 ;
...
-(char)valueForKey:(char)arg1 value:(int*)arg2 ;
-(id)initWithValidationFunction:(/*function pointer*/void*)arg1 rawValues:(const int*)arg2 forKeys:(const char*)arg3 count:(unsigned)arg4 ;
...
-(char)valueForKey:(char)arg1 rawValue:(int*)arg2 ;
-(void)setRawValue:(int)arg1 forKey:(char)arg2 ;
-(void)setValue:(int)arg1 forKey:(char)arg2 ;
-(unsigned)count;
-(id)init;
