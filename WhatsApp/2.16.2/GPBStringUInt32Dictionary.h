...
+(id)dictionaryWithValues:(const unsigned*)arg1 forKeys:(id*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned*)arg1 forKeys:(id*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(id)arg1 value:(unsigned*)arg2 ;
