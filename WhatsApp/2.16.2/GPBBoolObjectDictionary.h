...
+(id)dictionaryWithObjects:(const id*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
+(id)dictionaryWithObject:(id)arg1 forKey:(char)arg2 ;
+(id)dictionary;
...
-(id)initWithObjects:(const id*)arg1 forKeys:(const char*)arg2 count:(unsigned)arg3 ;
