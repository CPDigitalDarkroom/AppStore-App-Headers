...
+(id)dictionaryWithValues:(const int*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const int*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
