...
+(id)dictionaryWithValues:(const unsigned*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(int)arg1 value:(unsigned*)arg2 ;
