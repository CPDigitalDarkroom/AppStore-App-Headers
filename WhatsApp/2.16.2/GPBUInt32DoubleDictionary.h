...
+(id)dictionaryWithValues:(const double*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const double*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(unsigned)arg1 value:(double*)arg2 ;
