...
+(id)dictionaryWithValues:(const long long*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const long long*)arg1 forKeys:(const int*)arg2 count:(unsigned)arg3 ;
-(char)valueForKey:(int)arg1 value:(long long*)arg2 ;
